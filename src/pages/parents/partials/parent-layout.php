...
?>
<div class="min-h-screen bg-[url('/assets/img/background_school_material.webp')] bg-cover bg-center bg-no-repeat bg-fixed relative" style="background-color:transparent!important;">
