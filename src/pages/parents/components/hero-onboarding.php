...
<section class="relative flex flex-col items-center justify-center min-h-[340px] md:min-h-[420px] rounded-3xl shadow-lg overflow-hidden mb-8" style="background:transparent!important;">
    <video autoplay loop muted playsinline class="absolute inset-0 w-full h-full object-cover opacity-10 pointer-events-none">
        <source src="/assets/video/parent-hero-demo.mp4" type="video/mp4">
    </video>
    <div class="relative z-10 flex flex-col items-center justify-center py-10 px-4 md:px-12">
        ...
        <div class="flex flex-col md:flex-row gap-4 items-center mt-2">
            <img src="/assets/img/parent-famille-demo.png" alt="Famille" class="w-20 h-20 rounded-full shadow border-2 border-white/80">
