    ...
    <?php else: ?>
        ...
        <section class="learning-tips-section">
            ...
            <div class="tips-grid">
                <div class="tip-card">
                    <h3>📚 Spécialités</h3>
                    <p>Concentre-toi sur tes spécialités : elles comptent pour le BAC. Travaille-les régulièrement et approfondis les notions complexes.</p>
                </div>
                <div class="tip-card">
                    <h3>✍️ Bac de Français</h3>
                    <p>Lis les œuvres au programme, fais des fiches par texte, entraîne-toi aux exercices (commentaire, dissertation, oral). La préparation commence dès septembre !</p>
                </div>
                <div class="tip-card">
                    <h3>⏰ Organisation</h3>
                    <p>Planifie ton travail personnel. Entre les spécialités et le français, l'année est chargée. Anticipe et répartis tes efforts.</p>
                </div>
                <div class="tip-card">
                    <h3>💪 Grand oral</h3>
                    <p>Commence à réfléchir à tes questions de Grand Oral en lien avec tes spécialités. Plus tu prépares tôt, mieux c'est !</p>
                </div>
            </div>
        </section>
    <?php endif; ?>
