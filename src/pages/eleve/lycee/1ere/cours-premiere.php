...
<main class="main-content cours-main">
    ...
    <?php else: ?>
        <div class="coach-message">
            ...
            <br><small style="color: #666; font-style: italic;">💡 Mode démo : tu as accès à <strong>un seul cours Première</strong>. Crée un compte pour accéder à tous les cours !</small>
            <?php endif; ?>
        </div>
...
foreach ($subjectsToDisplay as $subject):
    ...
    $icon = $icons[$subject] ?? '📖';
    ?>
            <section id="<?php echo htmlspecialchars($subjectId); ?>" class="cours-section cours-premiere-section" style="display: none;">
