...
<main class="main-content cours-main">
    ...
    <?php else: ?>
        <div class="coach-message">
            ...
            <br><small style="color: #666; font-style: italic;">💡 Mode démo : tu as accès à <strong>un seul cours Seconde</strong>. Crée un compte pour accéder à tous les cours !</small>
            <?php endif; ?>
        </div>
...
foreach ($subjectsToDisplay as $subject):
    ...
    $icon = $icons[$subject] ?? '📖';
    ?>
            <section id="<?php echo htmlspecialchars($subjectId); ?>" class="cours-section cours-seconde-section" style="display: none;">
    ...
    if ($hasExercises) {
        ...
        <section class="learning-tips-section">
            ...
            <div class="tips-grid">
                <div class="tip-card"><h3>🎯 Adaptation</h3><p>Le lycée demande plus d'autonomie. Organise ton travail personnel, prends des notes claires et relis tes cours régulièrement.</p></div>
                <div class="tip-card"><h3>🔍 Exploration</h3><p>Profite de la Seconde pour découvrir différentes matières. Cela t'aidera à choisir tes spécialités en Première.</p></div>
                <div class="tip-card"><h3>📚 Méthode</h3><p>Apprends à rédiger : dissertation, commentaire, synthèse. Ces compétences te suivront jusqu'au BAC et au-delà !</p></div>
                <div class="tip-card"><h3>💪 Persévérance</h3><p>Les débuts peuvent être difficiles. Ne te décourage pas : demande de l'aide, travaille régulièrement, et les progrès viendront !</p></div>
            </div>
        </section>
    <?php endif; ?>
</main>
