    ...
    <?php else: ?>
        <div class="coach-message">
            ...
            <?php if ($is_demo && !$is_admin): ?>
                <br><small>💡 Mode démo : tu as accès à <strong>un seul cours 3ème</strong>. Crée un compte pour accéder à tous les cours et réussir ton brevet !</small>
            <?php endif; ?>
        </div>
        ...
        foreach ($subjectsToDisplay as $subject):
            ...
            $icon = $icons[$subject] ?? '📖';
        ?>
            <section id="<?php echo htmlspecialchars($subjectId); ?>" class="cours-section cours-3eme-section">
        ...
        <section class="learning-tips-section">
            ...
            <div class="tips-grid">
                <div class="tip-card">
                    <h3>📅 Planification</h3>
                    <p>Commence tes révisions tôt. Établis un planning équilibré qui couvre toutes les matières sans te surcharger.</p>
                </div>
                <div class="tip-card">
                    <h3>📝 Fiches de révision</h3>
                    <p>Crée des fiches synthétiques pour chaque chapitre. C'est le meilleur moyen de mémoriser et de réviser efficacement.</p>
                </div>
                <div class="tip-card">
                    <h3>🎯 Entraînement</h3>
                    <p>Fais des sujets blancs et des annales. Plus tu t'entraînes, plus tu seras à l'aise le jour J !</p>
                </div>
                <div class="tip-card">
                    <h3>😌 Gestion du stress</h3>
                    <p>Respire, fais des pauses, dors suffisamment. Un esprit reposé apprend mieux qu'un esprit fatigué. Tu vas y arriver !</p>
                </div>
            </div>
        </section>
    <?php endif; ?>
