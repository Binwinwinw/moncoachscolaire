...
$boot = remediation_guide_bootstrap($srcRoot, '3eme');
...
render_remediation_level_template([
    'theme_level' => '3eme',
    'title' => '📚 Guide de remédiation 3ème',
    'subtitle' => 'Programmes 2025 – Accompagnement personnalisé pour réussir ta 3ème et le Brevet',
    'nav_aria' => 'Navigation rapide 3ème',
    'section_aria' => 'Matières et remédiation 3ème',
    'theme' => $theme,
    'nav_links' => [
        ['href' => site_url('college/3eme/exercices-3eme'), 'label' => '📝 Mes Exercices', 'aria' => 'Mes exercices 3eme', 'tone' => 'primary'],
        ['href' => site_url('cours', ['niveau' => '3eme']), 'label' => '📚 Mes Cours', 'aria' => 'Mes cours', 'tone' => 'primary'],
    ...
    'subjects' => [
        ...
        ['id' => 'brevet', 'label' => 'Brevet', 'icon' => '🎓', 'tone_index' => 0, 'open_fn' => 'openMatiereModal'],
    ],
