...
$boot = remediation_guide_bootstrap($srcRoot, '4eme');
...
render_remediation_level_template([
    'theme_level' => '4eme',
    'title' => '📚 Guide de remédiation 4ème',
    'subtitle' => 'Programmes 2025 – Accompagnement personnalisé pour réussir ta 4ème',
    'nav_aria' => 'Navigation rapide 4ème',
    'section_aria' => 'Matières et remédiation 4ème',
    'theme' => $theme,
    'nav_links' => [
        ['href' => site_url('college/4eme/exercices-4eme'), 'label' => '📝 Mes Exercices', 'aria' => 'Mes exercices 4eme', 'tone' => 'primary'],
        ['href' => site_url('cours', ['niveau' => '4eme']), 'label' => '📚 Mes Cours', 'aria' => 'Mes cours', 'tone' => 'primary'],
