    ...
    <?php else: ?>
        ...
        <section class="learning-tips-section">
            ...
            <div class="tips-grid">
                <div class="tip-card">
                    <h3>🎯 Rigueur</h3>
                    <p>Les concepts deviennent abstraits. Prends des notes claires, relis tes cours régulièrement et n'hésite pas à refaire les exercices.</p>
                </div>
                <div class="tip-card">
                    <h3>📚 Anticiper</h3>
                    <p>La 4ème prépare au brevet ! Commence à acquérir les bonnes habitudes : fiches de révision, organisation, gestion du temps.</p>
                </div>
                <div class="tip-card">
                    <h3>💪 Persévérance</h3>
                    <p>Certaines notions peuvent sembler difficiles. Ne baisse pas les bras : cherche, demande de l'aide, réessaye. C'est en forgeant qu'on devient forgeron !</p>
                </div>
                <div class="tip-card">
                    <h3>🔍 Approfondir</h3>
                    <p>Ne te contente pas du minimum. Lis des livres, regarde des vidéos éducatives, cultive ta curiosité. C'est ce qui fait la différence !</p>
                </div>
            </div>
        </section>
    <?php endif; ?>
