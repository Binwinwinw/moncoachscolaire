...
$coachMessages = [
    ...
    <main class="main-content mx-auto flex w-full max-w-7xl flex-col gap-6 px-4 py-8 sm:px-6 lg:px-8">
    ...
    <script>
        (function() {
            ...
            async function refreshFamily() {
                try {
                    ...
                    if (!data.parents || data.parents.length === 0) {
                        ...
                        if (existing) existing.innerHTML = list;
                        else {
            ...
            async function attachCode() {
                ...
                try {
                    const data = await apiRequest('attach_code', 'POST', {
                        action: 'attach_code',
                        code
                    });
