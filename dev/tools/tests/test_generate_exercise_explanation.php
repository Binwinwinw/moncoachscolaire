<?php
/**
 * Test CLI de robustesse pour src/api/ia/generate_exercise_explanation.php
 */
...
$endpoint = $rootUrl . '/src/api/ia/generate_exercise_explanation.php';
$cookieFile = tempnam(sys_get_temp_dir(), 'mcs_explain_cookie_');
if ($cookieFile === false) {
...
echo "=== Exercise Explanation AI Test ===\n";
...
$scenarios = [
    [
        ...
        'payload' => [
            ...
            'official_correction' => 'On commence par réduire les termes semblables avant de conclure.',
            'provider' => 'openai',
            'incorrect_items' => [
                [
