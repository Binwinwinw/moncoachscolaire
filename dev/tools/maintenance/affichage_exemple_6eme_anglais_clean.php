<?php
// Affichage interactif des exercices de 6eme anglais à partir du fichier nettoyé exemple_exercice_6eme_anglais_clean.json
$file = __DIR__ . '/exemple_exercice_6eme_anglais_clean.json';
$data = json_decode(file_get_contents($file), true);
?><!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="UTF-8">
    <title>Exemples Exercices 6ème Anglais (Clean)</title>
    <style>
...
<body>
<div class="container">
    <h1>Exemples Exercices 6ème Anglais (Clean)</h1>
