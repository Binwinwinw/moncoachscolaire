# Script PowerShell pour extraire les 5 poses du sprite colibrirealiste.jpg
# Utilise .NET System.Drawing pour decouper l'image

$spriteFile = "assets\img\coach\colibrirealiste.jpg"
$outputDir = "assets\img\coach\colibri-sprites\realiste"
...
Write-Host "Extraction des poses du sprite Colibri Realiste..." -ForegroundColor Cyan
Write-Host ""
