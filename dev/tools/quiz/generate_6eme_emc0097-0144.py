        ...
        [
            {
                ...
                'options': ["Le drapeau tricolore, la Marseillaise, Marianne", "Le drapeau tricolore, la Marseillaise, le coq gaulois", "Marianne, le coq gaulois, la devise Liberté, Égalité, Fraternité", "Le drapeau tricolore, la devise Liberté, Égalité, Fraternité, Marianne"],
            ...
            },
            {
                ...
                'options': ["Marianne représente les valeurs de la République, notamment la liberté et la raison, et incarne l'esprit de la nation française.", "Marianne est un symbole militaire de la République.", "Marianne est une figure religieuse importante en France.", "Marianne est un personnage fictif de la littérature française."],
            ...
            },
            {
                ...
                'options': ["Le drapeau tricolore", "La Marseillaise", "Marianne", "Le coq gaulois"],
        ...
        [
            {
                ...
                'options': ["Le Président de la République, le Parlement, le Gouvernement", "Le Président de la République, le Conseil constitutionnel, le Conseil d'État", "Le Parlement, le Gouvernement, le Conseil constitutionnel", "Le Président de la République, le Parlement, le Conseil constitutionnel"],
            ...
            },
            {
                ...
                'options': ["Le Parlement élabore les lois, contrôle le Gouvernement et représente les citoyens.", "Le Parlement est responsable de la politique étrangère de la France.", "Le Parlement gère les finances publiques de la France.", "Le Parlement est chargé de la défense nationale."],
            ...
            },
            {
                ...
                'options': ["Le Président de la République représente la France à l'étranger, nomme le Premier ministre et peut dissoudre l'Assemblée nationale.", "Le Président de la République élabore les lois et contrôle le Gouvernement.", "Le Président de la République gère les finances publiques de la France.", "Le Président de la République est chargé de la défense nationale."],
            ...
            },
            {
                ...
                'options': ["Le Conseil d'État conseille le Gouvernement sur les questions juridiques et est la juridiction administrative suprême.", "Le Conseil d'État élabore les lois et contrôle le Gouvernement.", "Le Conseil d'État gère les finances publiques de la France.", "Le Conseil d'État est chargé de la défense nationale."],
        ...
        [
            {
                ...
                'options': ["Le droit de vote, la liberté d'expression, le droit à l'éducation", "Le droit de vote, la liberté de religion, le droit à la santé", "La liberté d'expression, le droit à l'éducation, le droit à la santé", "Le droit de vote, la liberté d'expression, le droit à la santé"],
            ...
            },
            {
                ...
                'options': ["Respecter les lois, payer des impôts, défendre la patrie", "Respecter les lois, payer des impôts, avoir une profession", "Payer des impôts, défendre la patrie, avoir une profession", "Respecter les lois, défendre la patrie, avoir une profession"],
            ...
            },
            {
                ...
                'options': ["Aider les personnes en difficulté, respecter les différences, participer à la vie de la communauté", "Aider les personnes en difficulté, respecter les différences, avoir une profession", "Respecter les différences, participer à la vie de la communauté, avoir une profession", "Aider les personnes en difficulté, participer à la vie de la communauté, avoir une profession"],
            ...
            },
            {
                ...
                'options': ["Respecter les lois, respecter les différences, participer à la vie de la communauté", "Respecter les lois, respecter les différences, avoir une profession", "Respecter les différences, participer à la vie de la communauté, avoir une profession", "Respecter les lois, participer à la vie de la communauté, avoir une profession"],
        ...
        [
            {
                ...
                'options': ["La séparation des Églises et de l'État, garantissant la liberté de conscience et d'expression religieuse", "La promotion d'une religion d'État en France", "L'interdiction de toute expression religieuse en public", "La coexistence pacifique de toutes les religions en France"],
            ...
            },
            {
                ...
                'options': ["L'État doit rester neutre vis-à-vis des religions et garantir la liberté de conscience pour tous les citoyens.", "L'État doit promouvoir une religion d'État pour unifier la nation.", "L'État doit interdire toute expression religieuse en public pour maintenir l'ordre.", "L'État doit favoriser le dialogue interreligieux pour promouvoir la coexistence pacifique."],
            ...
            },
            {
                ...
                'options': ["Les écoles publiques doivent enseigner les valeurs de la République et respecter la neutralité religieuse.", "Les écoles publiques doivent promouvoir une religion d'État pour unifier les élèves.", "Les écoles publiques doivent interdire toute expression religieuse pour maintenir l'ordre.", "Les écoles publiques doivent favoriser le dialogue interreligieux pour promouvoir la coexistence pacifique."],
        ...
        [
            {
                ...
                'options': ["La citoyenneté européenne est un statut qui confère des droits et des devoirs aux citoyens des États membres de l'Union européenne.", "La citoyenneté européenne est un statut qui confère des droits et des devoirs aux citoyens de tous les pays d'Europe.", "La citoyenneté européenne est un statut qui confère des droits et des devoirs aux citoyens de la France uniquement.", "La citoyenneté européenne est un statut qui confère des droits et des devoirs aux citoyens de l'Union européenne et de la France."],
            ...
            },
            {
                ...
                'options': ["Le droit de vote et d'éligibilité aux élections municipales, régionales, nationales et européennes dans l'État membre de résidence.", "Le droit de vote et d'éligibilité uniquement aux élections européennes.", "Le droit de vote et d'éligibilité uniquement aux élections nationales du pays d'origine.", "Le droit de vote et d'éligibilité uniquement aux élections municipales du pays de résidence."],
            ...
            },
            {
                ...
                'options': ["Le Parlement européen représente les citoyens européens au sein des institutions de l'Union européenne et participe à l'élaboration des lois européennes.", "Le Parlement européen gère les finances publiques de l'Union européenne.", "Le Parlement européen est chargé de la défense nationale de l'Union européenne.", "Le Parlement européen élabore les politiques étrangères de l'Union européenne."],
            ...
            },
            {
                ...
                'options': ["La Cour de justice de l'Union européenne veille à l'application uniforme du droit européen et protège les droits des citoyens européens.", "La Cour de justice de l'Union européenne gère les finances publiques de l'Union européenne.", "La Cour de justice de l'Union européenne est chargée de la défense nationale de l'Union européenne.", "La Cour de justice de l'Union européenne élabore les politiques étrangères de l'Union européenne."],
        ...
        [
            {
                ...
                'options': ["La solidarité internationale est un principe qui encourage les individus et les nations à s'entraider pour résoudre les problèmes mondiaux.", "La solidarité internationale est un concept qui promeut l'indépendance totale des nations.", "La solidarité internationale est une politique qui favorise uniquement les pays riches.", "La solidarité internationale est une idéologie qui prône la non-intervention dans les affaires des autres pays."],
            ...
            },
            {
                ...
                'options': ["L'aide humanitaire, le développement économique, la protection de l'environnement, la promotion des droits humains", "L'aide humanitaire, le développement économique, la promotion de la culture, la défense nationale", "Le développement économique, la protection de l'environnement, la promotion des droits humains, la gestion des ressources naturelles", "L'aide humanitaire, la promotion de la culture, la défense nationale, la gestion des ressources naturelles"],
            ...
            },
            {
                ...
                'options': ["Les ONG jouent un rôle crucial en fournissant une assistance directe, en sensibilisant le public et en plaidant pour des politiques plus justes au niveau international.", "Les ONG sont principalement responsables de la gestion des finances publiques dans les pays en développement.", "Les ONG sont chargées de la défense nationale dans les pays en développement.", "Les ONG sont responsables de l'élaboration des politiques étrangères des pays riches."],
            ...
            },
            {
                ...
                'options': ["Les citoyens peuvent contribuer à la solidarité internationale en faisant du bénévolat, en faisant des dons ou en sensibilisant aux enjeux mondiaux.", "Les citoyens n'ont aucun rôle à jouer dans la solidarité internationale, qui est uniquement une responsabilité des gouvernements.", "Les citoyens sont responsables de la gestion des finances publiques dans les pays en développement.", "Les citoyens sont chargés de la défense nationale dans les pays en développement."],
        ...
        [
            {
                ...
                'options': ["La citoyenneté française est un statut juridique qui confère des droits et des devoirs aux personnes reconnues comme membres de la nation française.", "La citoyenneté française est un statut juridique qui confère des droits et des devoirs aux personnes nées en France uniquement.", "La citoyenneté française est un statut juridique qui confère des droits et des devoirs aux personnes ayant des ancêtres français uniquement.", "La citoyenneté française est un statut juridique qui confère des droits et des devoirs aux personnes résidant en France depuis au moins 10 ans."],
            ...
            },
            {
                ...
                'options': ["Le droit de vote et d'éligibilité aux élections municipales, régionales, nationales et européennes.", "Le droit de vote et d'éligibilité uniquement aux élections municipales.", "Le droit de vote et d'éligibilité uniquement aux élections nationales.", "Le droit de vote et d'éligibilité uniquement aux élections européennes."],
            ...
            },
            {
                ...
                'options': ["La Constitution française établit les droits et les devoirs des citoyens français et organise les institutions de la République.", "La Constitution française gère les finances publiques de la France.", "La Constitution française est chargée de la défense nationale de la France.", "La Constitution française élabore les politiques étrangères de la France."],
            ...
            },
            {
                ...
                'options': ["Le Président de la République française est le chef de l'État et représente les citoyens français au niveau national et international.", "Le Président de la République française gère les finances publiques de la France.", "Le Président de la République française est chargé de la défense nationale de la France.", "Le Président de la République française élabore les politiques étrangères de la France."],
        ...
        [
            {
                ...
                'options': ["Le Président de la République, le Parlement, le Gouvernement, le Conseil constitutionnel", "Le Président de la République, le Parlement, le Gouvernement, la Cour de justice de l'Union européenne", "Le Président de la République, le Parlement, le Gouvernement, la Cour des comptes", "Le Président de la République, le Parlement, le Gouvernement, la Cour de cassation"],
            ...
            },
            {
                ...
                'options': ["Le Parlement français élabore les lois, contrôle le Gouvernement et représente les citoyens français.", "Le Parlement français gère les finances publiques de la France.", "Le Parlement français est chargé de la défense nationale de la France.", "Le Parlement français élabore les politiques étrangères de la France."],
            ...
            },
            {
                ...
                'options': ["Le Conseil constitutionnel veille à la conformité des lois à la Constitution et protège les droits fondamentaux des citoyens français.", "Le Conseil constitutionnel gère les finances publiques de la France.", "Le Conseil constitutionnel est chargé de la défense nationale de la France.", "Le Conseil constitutionnel élabore les politiques étrangères de la France."],
            ...
            },
            {
                ...
                'options': ["La liberté d'expression permet à chacun de s'exprimer librement, sans censure ni restriction.", "La liberté d'expression permet au gouvernement de contrôler les médias.", "La liberté d'expression interdit toute critique envers les autorités.", "La liberté d'expression est limitée aux discours publics uniquement."],
        ...
        [
            {
                ...
                'options': ["La liberté d'expression, le droit de vote, le droit à l'éducation", "Le droit de posséder des armes, le droit de ne pas payer d'impôts", "Le droit de ne pas respecter les lois, le droit de ne pas travailler", "Le droit de contrôler les médias, le droit de faire la guerre"],
            ...
            },
            {
                ...
                'type': "qcm",
                'question': "Quels sont les devoirs des citoyens français ?",
                'options': ["Respecter les lois, payer des impôts, participer à la vie démocratique", "Ne pas respecter les lois, ne pas payer d'impôts, ne pas participer à la vie démocratique", "Respecter les lois uniquement lorsqu'ils le souhaitent", "Payer des impôts uniquement lorsqu'ils en ont envie"],
            ...
            },
            {
                ...
                'options': ["La participation citoyenne permet aux citoyens de s'impliquer dans les décisions qui affectent leur vie et de contribuer au fonctionnement de la démocratie.", "La participation citoyenne est inutile dans une démocratie, car les décisions sont prises par les politiciens.", "La participation citoyenne est réservée aux élites politiques et économiques.", "La participation citoyenne est limitée aux élections uniquement."],
            ...
            },
            {
                ...
                'options': ["L'éducation civique permet aux citoyens français de comprendre leurs droits et devoirs, ainsi que le fonctionnement des institutions de la République.", "L'éducation civique est inutile dans la formation des citoyens français, car ils peuvent apprendre par eux-mêmes.", "L'éducation civique est réservée aux élites politiques et économiques.", "L'éducation civique est limitée aux écoles uniquement."],
        ...
        [
            {
                ...
                'options': ["Le respect des différences favorise la tolérance, l'inclusion et la diversité dans la société.", "Le respect des différences est inutile, car tout le monde devrait être pareil.", "Le respect des différences est réservé aux élites politiques et économiques.", "Le respect des différences est limité aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Le respect des différences favorise la créativité, l'innovation et la richesse culturelle dans la société.", "Le respect des différences est inutile, car tout le monde devrait être pareil.", "Le respect des différences est réservé aux élites politiques et économiques.", "Le respect des différences est limité aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["L'éducation joue un rôle crucial en sensibilisant les individus à la diversité et en promouvant le respect des différences.", "L'éducation est inutile dans le respect des différences, car les individus peuvent apprendre par eux-mêmes.", "L'éducation est réservée aux élites politiques et économiques.", "L'éducation est limitée aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les médias ont un rôle important en promouvant des représentations positives de la diversité et en sensibilisant le public au respect des différences.", "Les médias sont inutiles dans le respect des différences, car les individus peuvent apprendre par eux-mêmes.", "Les médias sont réservés aux élites politiques et économiques.", "Les médias sont limités aux écoles uniquement."],
        ...
        [
            {
                ...
                'options': ["Le respect de l'environnement contribue à la santé de la planète, à la préservation des ressources naturelles et à la qualité de vie des générations futures.", "Le respect de l'environnement est inutile, car la nature peut se régénérer toute seule.", "Le respect de l'environnement est réservé aux élites politiques et économiques.", "Le respect de l'environnement est limité aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Le respect de l'environnement favorise la santé publique, protège les écosystèmes et contribue à un avenir plus durable.", "Le respect de l'environnement est inutile, car la nature peut se régénérer toute seule.", "Le respect de l'environnement est réservé aux élites politiques et économiques.", "Le respect de l'environnement est limité aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["L'éducation joue un rôle crucial en sensibilisant les individus à l'importance du respect de l'environnement et en promouvant des comportements éco-responsables.", "L'éducation est inutile dans le respect de l'environnement, car les individus peuvent apprendre par eux-mêmes.", "L'éducation est réservée aux élites politiques et économiques.", "L'éducation est limitée aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les gouvernements ont un rôle important en adoptant des lois et des politiques pour protéger l'environnement et en encourageant les comportements éco-responsables.", "Les gouvernements sont inutiles dans le respect de l'environnement, car les individus peuvent agir par eux-mêmes.", "Les gouvernements sont réservés aux élites politiques et économiques.", "Les gouvernements sont limités aux écoles uniquement."],
        ...
        [
            {
                ...
                'options': ["Le respect des différences liées au handicap favorise l'inclusion, l'égalité des chances et la dignité des personnes en situation de handicap.", "Le respect des différences liées au handicap est inutile, car les personnes en situation de handicap devraient être traitées comme tout le monde.", "Le respect des différences liées au handicap est réservé aux élites politiques et économiques.", "Le respect des différences liées au handicap est limité aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Le respect des différences liées au handicap favorise la diversité, l'inclusion et la richesse humaine dans la société.", "Le respect des différences liées au handicap est inutile, car les personnes en situation de handicap devraient être traitées comme tout le monde.", "Le respect des différences liées au handicap est réservé aux élites politiques et économiques.", "Le respect des différences liées au handicap est limité aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["L'éducation joue un rôle crucial en sensibilisant les individus à la diversité et en promouvant le respect des différences liées au handicap.", "L'éducation est inutile dans le respect des différences liées au handicap, car les individus peuvent apprendre par eux-mêmes.", "L'éducation est réservée aux élites politiques et économiques.", "L'éducation est limitée aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les médias ont un rôle important en promouvant des représentations positives de la diversité et en sensibilisant le public au respect des différences liées au handicap.", "Les médias sont inutiles dans le respect des différences liées au handicap, car les individus peuvent apprendre par eux-mêmes.", "Les médias sont réservés aux élites politiques et économiques.", "Les médias sont limités aux écoles uniquement."],
        ...
        [
            {
                ...
                'options': ["Le respect de la diversité culturelle et religieuse favorise la tolérance, l'inclusion et la richesse culturelle dans la société.", "Le respect de la diversité culturelle et religieuse est inutile, car tout le monde devrait être pareil.", "Le respect de la diversité culturelle et religieuse est réservé aux élites politiques et économiques.", "Le respect de la diversité culturelle et religieuse est limité aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Le respect de la diversité culturelle et religieuse favorise la créativité, l'innovation et la richesse culturelle dans la société.", "Le respect de la diversité culturelle et religieuse est inutile, car tout le monde devrait être pareil.", "Le respect de la diversité culturelle et religieuse est réservé aux élites politiques et économiques.", "Le respect de la diversité culturelle et religieuse est limité aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["L'éducation joue un rôle crucial en sensibilisant les individus à la diversité et en promouvant le respect de la diversité culturelle et religieuse.", "L'éducation est inutile dans le respect de la diversité culturelle et religieuse, car les individus peuvent apprendre par eux-mêmes.", "L'éducation est réservée aux élites politiques et économiques.", "L'éducation est limitée aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les médias ont un rôle important en promouvant des représentations positives de la diversité et en sensibilisant le public au respect de la diversité culturelle et religieuse.", "Les médias sont inutiles dans le respect de la diversité culturelle et religieuse, car les individus peuvent apprendre par eux-mêmes.", "Les médias sont réservés aux élites politiques et économiques.", "Les médias sont limités aux écoles uniquement."],
        ...
        [
            {
                ...
                'options': ["La prévention du harcèlement scolaire contribue à créer un environnement scolaire sûr, respectueux et inclusif pour tous les élèves.", "La prévention du harcèlement scolaire est inutile, car le harcèlement fait partie de la vie.", "La prévention du harcèlement scolaire est réservée aux élites politiques et économiques.", "La prévention du harcèlement scolaire est limitée aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Il est important de signaler le harcèlement scolaire à un adulte de confiance, de soutenir la victime et de promouvoir un environnement scolaire respectueux.", "Il est préférable d'ignorer le harcèlement scolaire et de ne pas intervenir.", "Il est conseillé de rejoindre le harcèlement scolaire pour se protéger.", "Il est recommandé de filmer le harcèlement scolaire pour le partager sur les réseaux sociaux."],
            ...
            },
            {
                ...
                'options': ["L'éducation joue un rôle crucial en sensibilisant les élèves au harcèlement scolaire, en promouvant des comportements respectueux et en encourageant la solidarité entre les élèves.", "L'éducation est inutile dans la prévention du harcèlement scolaire, car les élèves peuvent apprendre par eux-mêmes.", "L'éducation est réservée aux élites politiques et économiques.", "L'éducation est limitée aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les parents ont un rôle important en sensibilisant leurs enfants au harcèlement scolaire, en encourageant des comportements respectueux et en collaborant avec les écoles pour prévenir le harcèlement.", "Les parents sont inutiles dans la prévention du harcèlement scolaire, car les élèves peuvent apprendre par eux-mêmes.", "Les parents sont réservés aux élites politiques et économiques.", "Les parents sont limités aux écoles uniquement."],
        ...
        [
            {
                ...
                'options': ["Le respect des droits de l'enfant garantit la protection, le bien-être et le développement des enfants, en leur permettant de vivre dans un environnement sûr et épanouissant.", "Le respect des droits de l'enfant est inutile, car les enfants n'ont pas besoin de droits spécifiques.", "Le respect des droits de l'enfant est réservé aux élites politiques et économiques.", "Le respect des droits de l'enfant est limité aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Le respect des droits de l'enfant favorise le développement, la protection et le bien-être des enfants, en leur permettant de vivre dans un environnement sûr et épanouissant.", "Le respect des droits de l'enfant est inutile, car les enfants n'ont pas besoin de droits spécifiques.", "Le respect des droits de l'enfant est réservé aux élites politiques et économiques.", "Le respect des droits de l'enfant est limité aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["L'éducation joue un rôle crucial en sensibilisant les individus aux droits de l'enfant et en promouvant le respect de ces droits.", "L'éducation est inutile dans le respect des droits de l'enfant, car les individus peuvent apprendre par eux-mêmes.", "L'éducation est réservée aux élites politiques et économiques.", "L'éducation est limitée aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les médias ont un rôle important en promouvant des représentations positives des enfants et en sensibilisant le public au respect des droits de l'enfant.", "Les médias sont inutiles dans le respect des droits de l'enfant, car les individus peuvent apprendre par eux-mêmes.", "Les médias sont réservés aux élites politiques et économiques.", "Les médias sont limités aux écoles uniquement."],
        ...
        [
            {
                ...
                'options': ["Le respect des devoirs et des sanctions contribue à maintenir l'ordre, la justice et la sécurité dans la société.", "Le respect des devoirs et des sanctions est inutile, car les individus peuvent agir comme ils le souhaitent.", "Le respect des devoirs et des sanctions est réservé aux élites politiques et économiques.", "Le respect des devoirs et des sanctions est limité aux écoles uniquement."],
    ...
    (
        ...
        [
            ...
            },
            {
                ...
                'options': ["L'éducation joue un rôle crucial en sensibilisant les individus aux devoirs et aux sanctions et en promouvant le respect de ces règles.", "L'éducation est inutile dans le respect des devoirs et des sanctions, car les individus peuvent apprendre par eux-mêmes.", "L'éducation est réservée aux élites politiques et économiques.", "L'éducation est limitée aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les médias ont un rôle important en promouvant des représentations positives du respect des devoirs et des sanctions et en sensibilisant le public à l'importance de ces règles.", "Les médias sont inutiles dans le respect des devoirs et des sanctions, car les individus peuvent apprendre par eux-mêmes.", "Les médias sont réservés aux élites politiques et économiques.", "Les médias sont limités aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les parents ont un rôle important en sensibilisant leurs enfants aux devoirs et aux sanctions et en promouvant le respect de ces règles.", "Les parents sont inutiles dans le respect des devoirs et des sanctions, car les individus peuvent apprendre par eux-mêmes.", "Les parents sont réservés aux élites politiques et économiques.", "Les parents sont limités aux écoles uniquement."],
        ...
        [
            {
                ...
                'options': ["Le respect des lois et de la justice garantit la protection des droits, la sécurité et l'équité dans la société.", "Le respect des lois et de la justice est inutile, car les individus peuvent agir comme ils le souhaitent.", "Le respect des lois et de la justice est réservé aux élites politiques et économiques.", "Le respect des lois et de la justice est limité aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["L'éducation joue un rôle crucial en sensibilisant les individus aux lois et à la justice et en promouvant le respect de ces règles.", "L'éducation est inutile dans le respect des lois et de la justice, car les individus peuvent apprendre par eux-mêmes.", "L'éducation est réservée aux élites politiques et économiques.", "L'éducation est limitée aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les médias ont un rôle important en promouvant des représentations positives du respect des lois et de la justice et en sensibilisant le public à l'importance de ces règles.", "Les médias sont inutiles dans le respect des lois et de la justice, car les individus peuvent apprendre par eux-mêmes.", "Les médias sont réservés aux élites politiques et économiques.", "Les médias sont limités aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les parents ont un rôle important en sensibilisant leurs enfants aux lois et à la justice et en promouvant le respect de ces règles.", "Les parents sont inutiles dans le respect des lois et de la justice, car les individus peuvent apprendre par eux-mêmes.", "Les parents sont réservés aux élites politiques et économiques.", "Les parents sont limités aux écoles uniquement."],
        ...
        [
            {
                ...
                'options': ["Le respect de la propriété d'autrui et la prévention du vol contribuent à maintenir l'ordre, la justice et la sécurité dans la société.", "Le respect de la propriété d'autrui et la prévention du vol sont inutiles, car les individus peuvent agir comme ils le souhaitent.", "Le respect de la propriété d'autrui et la prévention du vol sont réservés aux élites politiques et économiques.", "Le respect de la propriété d'autrui et la prévention du vol sont limités aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["L'éducation joue un rôle crucial en sensibilisant les individus au respect de la propriété d'autrui et à la prévention du vol et en promouvant le respect de ces règles.", "L'éducation est inutile dans le respect de la propriété d'autrui et la prévention du vol, car les individus peuvent apprendre par eux-mêmes.", "L'éducation est réservée aux élites politiques et économiques.", "L'éducation est limitée aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les médias ont un rôle important en promouvant des représentations positives du respect de la propriété d'autrui et de la prévention du vol et en sensibilisant le public à l'importance de ces règles.", "Les médias sont inutiles dans le respect de la propriété d'autrui et la prévention du vol, car les individus peuvent apprendre par eux-mêmes.", "Les médias sont réservés aux élites politiques et économiques.", "Les médias sont limités aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les parents ont un rôle important en sensibilisant leurs enfants au respect de la propriété d'autrui et à la prévention du vol et en promouvant le respect de ces règles.", "Les parents sont inutiles dans le respect de la propriété d'autrui et la prévention du vol, car les individus peuvent apprendre par eux-mêmes.", "Les parents sont réservés aux élites politiques et économiques.", "Les parents sont limités aux écoles uniquement."],
        ...
        [
            {
                ...
                'options': ["Le respect des règles de sécurité routière garantit la protection de tous les usagers de la route, en réduisant les risques d'accidents et en assurant la sécurité de tous.", "Le respect des règles de sécurité routière est inutile, car les individus peuvent agir comme ils le souhaitent.", "Le respect des règles de sécurité routière est réservé aux élites politiques et économiques.", "Le respect des règles de sécurité routière est limité aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["L'éducation joue un rôle crucial en sensibilisant les individus aux règles de sécurité routière et en promouvant le respect de ces règles.", "L'éducation est inutile dans le respect des règles de sécurité routière, car les individus peuvent apprendre par eux-mêmes.", "L'éducation est réservée aux élites politiques et économiques.", "L'éducation est limitée aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les médias ont un rôle important en promouvant des représentations positives du respect des règles de sécurité routière et en sensibilisant le public à l'importance de ces règles.", "Les médias sont inutiles dans le respect des règles de sécurité routière, car les individus peuvent apprendre par eux-mêmes.", "Les médias sont réservés aux élites politiques et économiques.", "Les médias sont limités aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les parents ont un rôle important en sensibilisant leurs enfants aux règles de sécurité routière et en promouvant le respect de ces règles.", "Les parents sont inutiles dans le respect des règles de sécurité routière, car les individus peuvent apprendre par eux-mêmes.", "Les parents sont réservés aux élites politiques et économiques.", "Les parents sont limités aux écoles uniquement."],
        ...
        [
            {
                ...
                'options': ["Le respect des biens communs garantit la préservation de l'environnement, la sécurité et le bien-être de tous les membres de la société.", "Le respect des biens communs est inutile, car les individus peuvent agir comme ils le souhaitent.", "Le respect des biens communs est réservé aux élites politiques et économiques.", "Le respect des biens communs est limité aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["L'éducation joue un rôle crucial en sensibilisant les individus au respect des biens communs et en promouvant le respect de ces règles.", "L'éducation est inutile dans le respect des biens communs, car les individus peuvent apprendre par eux-mêmes.", "L'éducation est réservée aux élites politiques et économiques.", "L'éducation est limitée aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les médias ont un rôle important en promouvant des représentations positives du respect des biens communs et en sensibilisant le public à l'importance de ces règles.", "Les médias sont inutiles dans le respect des biens communs, car les individus peuvent apprendre par eux-mêmes.", "Les médias sont réservés aux élites politiques et économiques.", "Les médias sont limités aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les parents ont un rôle important en enseignant à leurs enfants le respect des biens communs et en les encourageant à adopter des comportements responsables.", "Les parents n'ont aucun rôle dans le respect des biens communs, car cela relève uniquement de l'école.", "Les parents doivent uniquement se concentrer sur l'éducation académique de leurs enfants.", "Les parents doivent laisser leurs enfants apprendre par eux-mêmes sans intervention."],
        ...
        [
            {
                ...
                'type': "qcm",
                'question': "Pourquoi est-il important de respecter les devoirs et les sanctions dans la société ?",
                'options': ["Le respect des devoirs et des sanctions garantit la protection des droits, la sécurité et l'équité dans la société.", "Le respect des devoirs et des sanctions est inutile, car les individus peuvent agir comme ils le souhaitent.", "Le respect des devoirs et des sanctions est réservé aux élites politiques et économiques.", "Le respect des devoirs et des sanctions est limité aux écoles uniquement."],
        ...
        [
            {
                ...
                'options': ["Le respect des institutions locales garantit le bon fonctionnement de la démocratie, la participation citoyenne et la gestion efficace des services publics.", "Le respect des institutions locales est inutile, car les individus peuvent agir comme ils le souhaitent.", "Le respect des institutions locales est réservé aux élites politiques et économiques.", "Le respect des institutions locales est limité aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["L'éducation joue un rôle crucial en sensibilisant les individus au respect des institutions locales et en promouvant le respect de ces règles.", "L'éducation est inutile dans le respect des institutions locales, car les individus peuvent apprendre par eux-mêmes.", "L'éducation est réservée aux élites politiques et économiques.", "L'éducation est limitée aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les médias ont un rôle important en promouvant des représentations positives du respect des institutions locales et en sensibilisant le public à l'importance de ces règles.", "Les médias sont inutiles dans le respect des institutions locales, car les individus peuvent apprendre par eux-mêmes.", "Les médias sont réservés aux élites politiques et économiques.", "Les médias sont limités aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les parents ont un rôle important en sensibilisant leurs enfants au respect des institutions locales et en promouvant le respect de ces règles.", "Les parents sont inutiles dans le respect des institutions locales, car les individus peuvent apprendre par eux-mêmes.", "Les parents sont réservés aux élites politiques et économiques.", "Les parents sont limités aux écoles uniquement."],
        ...
        [
            {
                ...
                'options': ["Le respect des règles de vérification des informations garantit la diffusion d'informations fiables, la protection contre la désinformation et la promotion d'une société informée et responsable.", "Le respect des règles de vérification des informations est inutile, car les individus peuvent croire ce qu'ils veulent.", "Le respect des règles de vérification des informations est réservé aux élites politiques et économiques.", "Le respect des règles de vérification des informations est limité aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["L'éducation joue un rôle crucial en sensibilisant les individus aux règles de vérification des informations et en promouvant le respect de ces règles.", "L'éducation est inutile dans le respect des règles de vérification des informations, car les individus peuvent apprendre par eux-mêmes.", "L'éducation est réservée aux élites politiques et économiques.", "L'éducation est limitée aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les médias ont un rôle important en promouvant des représentations positives du respect des règles de vérification des informations et en sensibilisant le public à l'importance de ces règles.", "Les médias sont inutiles dans le respect des règles de vérification des informations, car les individus peuvent apprendre par eux-mêmes.", "Les médias sont réservés aux élites politiques et économiques.", "Les médias sont limités aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les parents ont un rôle important en sensibilisant leurs enfants aux règles de vérification des informations et en promouvant le respect de ces règles.", "Les parents sont inutiles dans le respect des règles de vérification des informations, car les individus peuvent apprendre par eux-mêmes.", "Les parents sont réservés aux élites politiques et économiques.", "Les parents sont limités aux écoles uniquement."],
        ...
        [
            {
                ...
                'options': ["Le respect des règles du débat argumenté garantit la promotion d'une discussion constructive, le respect des opinions divergentes et la construction d'une société démocratique et pluraliste.", "Le respect des règles du débat argumenté est inutile, car les individus peuvent exprimer leurs opinions comme ils le souhaitent.", "Le respect des règles du débat argumenté est réservé aux élites politiques et économiques.", "Le respect des règles du débat argumenté est limité aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["L'éducation joue un rôle crucial en sensibilisant les individus aux règles du débat argumenté et en promouvant le respect de ces règles.", "L'éducation est inutile dans le respect des règles du débat argumenté, car les individus peuvent apprendre par eux-mêmes.", "L'éducation est réservée aux élites politiques et économiques.", "L'éducation est limitée aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les médias ont un rôle important en promouvant des représentations positives du respect des règles du débat argumenté et en sensibilisant le public à l'importance de ces règles.", "Les médias sont inutiles dans le respect des règles du débat argumenté, car les individus peuvent apprendre par eux-mêmes.", "Les médias sont réservés aux élites politiques et économiques.", "Les médias sont limités aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les parents ont un rôle important en sensibilisant leurs enfants aux règles du débat argumenté et en promouvant le respect de ces règles.", "Les parents sont inutiles dans le respect des règles du débat argumenté, car les individus peuvent apprendre par eux-mêmes.", "Les parents sont réservés aux élites politiques et économiques.", "Les parents sont limités aux écoles uniquement."],
        ...
        [
            {
                ...
                'options': ["Le respect des règles de consommation responsable garantit la protection des consommateurs, la promotion de pratiques commerciales éthiques et la construction d'une société plus durable et équitable.", "Le respect des règles de consommation responsable est inutile, car les individus peuvent consommer comme ils le souhaitent.", "Le respect des règles de consommation responsable est réservé aux élites politiques et économiques.", "Le respect des règles de consommation responsable est limité aux écoles uniquement."],
    ...
    (
        ...
        [
            ...
            },
            {
                ...
                'options': ["L'éducation joue un rôle crucial en sensibilisant les individus aux règles de consommation responsable et en promouvant le respect de ces règles.", "L'éducation est inutile dans le respect des règles de consommation responsable, car les individus peuvent apprendre par eux-mêmes.", "L'éducation est réservée aux élites politiques et économiques.", "L'éducation est limitée aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les médias ont un rôle important en promouvant des représentations positives du respect des règles de consommation responsable et en sensibilisant le public à l'importance de ces règles.", "Les médias sont inutiles dans le respect des règles de consommation responsable, car les individus peuvent apprendre par eux-mêmes.", "Les médias sont réservés aux élites politiques et économiques.", "Les médias sont limités aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les médias n'ont aucun impact sur le respect des règles de consommation responsable.", "Les médias peuvent influencer positivement ou négativement le respect des règles de consommation responsable.", "Les médias sont uniquement responsables de la promotion des comportements irresponsables.", "Les médias sont uniquement responsables de la promotion des comportements responsables."],
        ...
        [
            {
                ...
                'options': ["Le respect des règles éthiques garantit la promotion de comportements moraux, le respect des autres et la construction d'une société plus juste et solidaire.", "Le respect des règles éthiques est inutile, car les individus peuvent agir comme ils le souhaitent.", "Le respect des règles éthiques est réservé aux élites politiques et économiques.", "Le respect des règles éthiques est limité aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["L'éducation joue un rôle crucial en sensibilisant les individus aux règles éthiques et en promouvant le respect de ces règles.", "L'éducation est inutile dans le respect des règles éthiques, car les individus peuvent apprendre par eux-mêmes.", "L'éducation est réservée aux élites politiques et économiques.", "L'éducation est limitée aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les médias ont un rôle important en promouvant des représentations positives du respect des règles éthiques et en sensibilisant le public à l'importance de ces règles.", "Les médias sont inutiles dans le respect des règles éthiques, car les individus peuvent apprendre par eux-mêmes.", "Les médias sont réservés aux élites politiques et économiques.", "Les médias sont limités aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les parents ont un rôle important en sensibilisant leurs enfants aux règles éthiques et en promouvant le respect de ces règles.", "Les parents sont inutiles dans le respect des règles éthiques, car les individus peuvent apprendre par eux-mêmes.", "Les parents sont réservés aux élites politiques et économiques.", "Les parents sont limités aux écoles uniquement."],
        ...
        [
            {
                ...
                'options': ["Le respect des règles de liberté de conscience garantit la promotion de la diversité des opinions, le respect des croyances individuelles et la construction d'une société plus tolérante et inclusive.", "Le respect des règles de liberté de conscience est inutile, car les individus peuvent croire ce qu'ils veulent.", "Le respect des règles de liberté de conscience est réservé aux élites politiques et économiques.", "Le respect des règles de liberté de conscience est limité aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["L'éducation joue un rôle crucial en sensibilisant les individus aux règles de liberté de conscience et en promouvant le respect de ces règles.", "L'éducation est inutile dans le respect des règles de liberté de conscience, car les individus peuvent apprendre par eux-mêmes.", "L'éducation est réservée aux élites politiques et économiques.", "L'éducation est limitée aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les médias ont un rôle important en promouvant des représentations positives du respect des règles de liberté de conscience et en sensibilisant le public à l'importance de ces règles.", "Les médias sont inutiles dans le respect des règles de liberté de conscience, car les individus peuvent apprendre par eux-mêmes.", "Les médias sont réservés aux élites politiques et économiques.", "Les médias sont limités aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les parents ont un rôle important en sensibilisant leurs enfants aux règles de liberté de conscience et en promouvant le respect de ces règles.", "Les parents sont inutiles dans le respect des règles de liberté de conscience, car les individus peuvent apprendre par eux-mêmes.", "Les parents sont réservés aux élites politiques et économiques.", "Les parents sont limités aux écoles uniquement."],
        ...
        [
            {
                ...
                'options': ["Le respect des règles de laïcité à l'école garantit la promotion de la liberté de conscience, le respect des croyances individuelles et la construction d'une société plus tolérante et inclusive.", "Le respect des règles de laïcité à l'école est inutile, car les individus peuvent croire ce qu'ils veulent.", "Le respect des règles de laïcité à l'école est réservé aux élites politiques et économiques.", "Le respect des règles de laïcité à l'école est limité aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["L'éducation joue un rôle crucial en sensibilisant les individus aux règles de laïcité et en promouvant le respect de ces règles.", "L'éducation est inutile dans le respect des règles de laïcité, car les individus peuvent apprendre par eux-mêmes.", "L'éducation est réservée aux élites politiques et économiques.", "L'éducation est limitée aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les médias ont un rôle important en promouvant des représentations positives du respect des règles de laïcité et en sensibilisant le public à l'importance de ces règles.", "Les médias sont inutiles dans le respect des règles de laïcité, car les individus peuvent apprendre par eux-mêmes.", "Les médias sont réservés aux élites politiques et économiques.", "Les médias sont limités aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les parents ont un rôle important en sensibilisant leurs enfants aux règles de laïcité et en promouvant le respect de ces règles.", "Les parents sont inutiles dans le respect des règles de laïcité, car les individus peuvent apprendre par eux-mêmes.", "Les parents sont réservés aux élites politiques et économiques.", "Les parents sont limités aux écoles uniquement."],
        ...
        [
            {
                ...
                'options': ["Le respect des règles des droits humains garantit la promotion de la dignité humaine, le respect des libertés fondamentales et la construction d'une société plus juste et égalitaire.", "Le respect des règles des droits humains est inutile, car les individus peuvent agir comme ils le souhaitent.", "Le respect des règles des droits humains est réservé aux élites politiques et économiques.", "Le respect des règles des droits humains est limité aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["L'éducation joue un rôle crucial en sensibilisant les individus aux règles des droits humains et en promouvant le respect de ces règles.", "L'éducation est inutile dans le respect des règles des droits humains, car les individus peuvent apprendre par eux-mêmes.", "L'éducation est réservée aux élites politiques et économiques.", "L'éducation est limitée aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les médias ont un rôle important en promouvant des représentations positives du respect des règles des droits humains et en sensibilisant le public à l'importance de ces règles.", "Les médias sont inutiles dans le respect des règles des droits humains, car les individus peuvent apprendre par eux-mêmes.", "Les médias sont réservés aux élites politiques et économiques.", "Les médias sont limités aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les parents ont un rôle important en sensibilisant leurs enfants aux règles des droits humains et en promouvant le respect de ces règles.", "Les parents sont inutiles dans le respect des règles des droits humains, car les individus peuvent apprendre par eux-mêmes.", "Les parents sont réservés aux élites politiques et économiques.", "Les parents sont limités aux écoles uniquement."],
        ...
        [
            {
                ...
                'options': ["Le respect des règles de jugement moral dans les cas concrets garantit la promotion de comportements éthiques, le respect des autres et la construction d'une société plus juste et solidaire.", "Le respect des règles de jugement moral dans les cas concrets est inutile, car les individus peuvent agir comme ils le souhaitent.", "Le respect des règles de jugement moral dans les cas concrets est réservé aux élites politiques et économiques.", "Le respect des règles de jugement moral dans les cas concrets est limité aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["L'éducation joue un rôle crucial en sensibilisant les individus aux règles de jugement moral et en promouvant le respect de ces règles.", "L'éducation est inutile dans le respect des règles de jugement moral, car les individus peuvent apprendre par eux-mêmes.", "L'éducation est réservée aux élites politiques et économiques.", "L'éducation est limitée aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les médias ont un rôle important en promouvant des représentations positives du respect des règles de jugement moral et en sensibilisant le public à l'importance de ces règles.", "Les médias sont inutiles dans le respect des règles de jugement moral, car les individus peuvent apprendre par eux-mêmes.", "Les médias sont réservés aux élites politiques et économiques.", "Les médias sont limités aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les enseignants ont un rôle important en promouvant des représentations positives du respect des règles de jugement moral et en sensibilisant les élèves à l'importance de ces règles.", "Les enseignants sont inutiles dans le respect des règles de jugement moral, car les élèves peuvent apprendre par eux-mêmes.", "Les enseignants sont réservés aux élèves les plus avancés.", "Les enseignants sont limités aux matières scientifiques uniquement."],
        ...
        [
            {
                ...
                'options': ["Le respect des règles de critique de la publicité garantit la promotion d'une consommation responsable, le respect des autres et la construction d'une société plus juste et solidaire.", "Le respect des règles de critique de la publicité est inutile, car les individus peuvent agir comme ils le souhaitent.", "Le respect des règles de critique de la publicité est réservé aux élites politiques et économiques.", "Le respect des règles de critique de la publicité est limité aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["L'éducation joue un rôle crucial en sensibilisant les individus aux règles de critique de la publicité et en promouvant le respect de ces règles.", "L'éducation est inutile dans le respect des règles de critique de la publicité, car les individus peuvent apprendre par eux-mêmes.", "L'éducation est réservée aux élites politiques et économiques.", "L'éducation est limitée aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les médias ont un rôle important en promouvant des représentations positives du respect des règles de critique de la publicité et en sensibilisant le public à l'importance de ces règles.", "Les médias sont inutiles dans le respect des règles de critique de la publicité, car les individus peuvent apprendre par eux-mêmes.", "Les médias sont réservés aux élites politiques et économiques.", "Les médias sont limités aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les parents ont un rôle important en sensibilisant leurs enfants aux règles de critique de la publicité et en promouvant le respect de ces règles.", "Les parents sont inutiles dans le respect des règles de critique de la publicité, car les individus peuvent apprendre par eux-mêmes.", "Les parents sont réservés aux élites politiques et économiques.", "Les parents sont limités aux écoles uniquement."],
        ...
        [
            {
                ...
                'options': ["Le respect des règles de recherche de sources fiables garantit la promotion d'une information de qualité, le respect des autres et la construction d'une société plus juste et solidaire.", "Le respect des règles de recherche de sources fiables est inutile, car les individus peuvent agir comme ils le souhaitent.", "Le respect des règles de recherche de sources fiables est réservé aux élites politiques et économiques.", "Le respect des règles de recherche de sources fiables est limité aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["L'éducation joue un rôle crucial en sensibilisant les individus aux règles de recherche de sources fiables et en promouvant le respect de ces règles.", "L'éducation est inutile dans le respect des règles de recherche de sources fiables, car les individus peuvent apprendre par eux-mêmes.", "L'éducation est réservée aux élites politiques et économiques.", "L'éducation est limitée aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Il favorise la diffusion d'une information de qualité et le respect des autres.", "Il n'a aucun impact sur la société.", "Il limite la liberté d'expression.", "Il est uniquement bénéfique pour les chercheurs."],
            ...
            },
            {
                ...
                'options': ["Les parents ont un rôle important en sensibilisant leurs enfants aux règles de recherche de sources fiables et en promouvant le respect de ces règles.", "Les parents sont inutiles dans le respect des règles de recherche de sources fiables, car les individus peuvent apprendre par eux-mêmes.", "Les parents sont réservés aux élites politiques et économiques.", "Les parents sont limités aux écoles uniquement."],
        ...
        [
            {
                ...
                'options': ["Le respect des règles des projets collectifs à l'école garantit la promotion de la collaboration, le respect des autres et la construction d'une société plus juste et solidaire.", "Le respect des règles des projets collectifs à l'école est inutile, car les individus peuvent agir comme ils le souhaitent.", "Le respect des règles des projets collectifs à l'école est réservé aux élites politiques et économiques.", "Le respect des règles des projets collectifs à l'école est limité aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["L'éducation joue un rôle crucial en sensibilisant les individus aux règles des projets collectifs et en promouvant le respect de ces règles.", "L'éducation est inutile dans le respect des règles des projets collectifs, car les individus peuvent apprendre par eux-mêmes.", "L'éducation est réservée aux élites politiques et économiques.", "L'éducation est limitée aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les enseignants ont un rôle important en promouvant des représentations positives du respect des règles des projets collectifs et en sensibilisant les élèves à l'importance de ces règles.", "Les enseignants sont inutiles dans le respect des règles des projets collectifs, car les élèves peuvent apprendre par eux-mêmes.", "Les enseignants sont réservés aux élèves les plus avancés.", "Les enseignants sont limités aux matières scientifiques uniquement."],
            ...
            },
            {
                ...
                'options': ["Les parents ont un rôle important en sensibilisant leurs enfants aux règles des projets collectifs et en promouvant le respect de ces règles.", "Les parents sont inutiles dans le respect des règles des projets collectifs, car les individus peuvent apprendre par eux-mêmes.", "Les parents sont réservés aux élites politiques et économiques.", "Les parents sont limités aux écoles uniquement."],
        ...
        [
            {
                ...
                'options': ["Le respect des règles de solidarité garantit la promotion de l'entraide, le respect des autres et la construction d'une société plus juste et solidaire.", "Le respect des règles de solidarité est inutile, car les individus peuvent agir comme ils le souhaitent.", "Le respect des règles de solidarité est réservé aux élites politiques et économiques.", "Le respect des règles de solidarité est limité aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["L'éducation joue un rôle crucial en sensibilisant les individus aux règles de solidarité et en promouvant le respect de ces règles.", "L'éducation est inutile dans le respect des règles de solidarité, car les individus peuvent apprendre par eux-mêmes.", "L'éducation est réservée aux élites politiques et économiques.", "L'éducation est limitée aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les médias jouent un rôle crucial en sensibilisant le public aux règles de solidarité et en promouvant le respect de ces règles.", "Les médias sont inutiles dans le respect des règles de solidarité, car les individus peuvent apprendre par eux-mêmes.", "Les médias sont réservés aux élites politiques et économiques.", "Les médias sont limités aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les parents ont un rôle important en sensibilisant leurs enfants aux règles de solidarité et en promouvant le respect de ces règles.", "Les parents sont inutiles dans le respect des règles de solidarité, car les individus peuvent apprendre par eux-mêmes.", "Les parents sont réservés aux élites politiques et économiques.", "Les parents sont limités aux écoles uniquement."],
        ...
        [
            {
                ...
                'type': "qcm",
                'question': "Pourquoi est-il important de respecter les règles de jugement moral dans les cas concrets ?",
                'options': ["Le respect des règles de jugement moral dans les cas concrets garantit la promotion d'une société plus juste et solidaire.", "Le respect des règles de jugement moral dans les cas concrets est inutile, car les individus peuvent agir comme ils le souhaitent.", "Le respect des règles de jugement moral dans les cas concrets est réservé aux élites politiques et économiques.", "Le respect des règles de jugement moral dans les cas concrets est limité aux écoles uniquement."],
            ...
            },
            {
                ...
                'type': "qcm",
                'question': "Quel est le rôle de l'éducation dans le respect des règles de jugement moral dans les cas concrets ?",
                'options': ["L'éducation joue un rôle crucial en sensibilisant les individus aux règles de jugement moral dans les cas concrets et en promouvant le respect de ces règles.", "L'éducation est inutile dans le respect des règles de jugement moral dans les cas concrets, car les individus peuvent apprendre par eux-mêmes.", "L'éducation est réservée aux élites politiques et économiques.", "L'éducation est limitée aux écoles uniquement."],
            ...
            },
            {
                ...
                'type': "qcm",
                'question': "Quel est le rôle des médias dans le respect des règles de jugement moral dans les cas concrets ?",
                'options': ["Les médias jouent un rôle crucial en sensibilisant le public aux règles de jugement moral dans les cas concrets et en promouvant le respect de ces règles.", "Les médias sont inutiles dans le respect des règles de jugement moral dans les cas concrets, car les individus peuvent apprendre par eux-mêmes.", "Les médias sont réservés aux élites politiques et économiques.", "Les médias sont limités aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les parents ont un rôle important en sensibilisant leurs enfants aux règles de jugement moral dans les cas concrets et en promouvant le respect de ces règles.", "Les parents sont inutiles dans le respect des règles de jugement moral dans les cas concrets, car les individus peuvent apprendre par eux-mêmes.", "Les parents sont réservés aux élites politiques et économiques.", "Les parents sont limités aux écoles uniquement."],
        ...
        [
            {
                ...
                'options': ["Le respect des règles de vie démocratique à l'école garantit la promotion de la participation, le respect des autres et la construction d'une société plus juste et solidaire.", "Le respect des règles de vie démocratique à l'école est inutile, car les individus peuvent agir comme ils le souhaitent.", "Le respect des règles de vie démocratique à l'école est réservé aux élites politiques et économiques.", "Le respect des règles de vie démocratique à l'école est limité aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["L'éducation joue un rôle crucial en sensibilisant les individus aux règles de vie démocratique à l'école et en promouvant le respect de ces règles.", "L'éducation est inutile dans le respect des règles de vie démocratique à l'école, car les individus peuvent apprendre par eux-mêmes.", "L'éducation est réservée aux élites politiques et économiques.", "L'éducation est limitée aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les médias jouent un rôle crucial en sensibilisant le public aux règles de vie démocratique à l'école et en promouvant le respect de ces règles.", "Les médias sont inutiles dans le respect des règles de vie démocratique à l'école, car les individus peuvent apprendre par eux-mêmes.", "Les médias sont réservés aux élites politiques et économiques.", "Les médias sont limités aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les parents ont un rôle important en sensibilisant leurs enfants aux règles de vie démocratique à l'école et en promouvant le respect de ces règles.", "Les parents sont inutiles dans le respect des règles de vie démocratique à l'école, car les individus peuvent apprendre par eux-mêmes.", "Les parents sont réservés aux élites politiques et économiques.", "Les parents sont limités aux écoles uniquement."],
        ...
        [
            {
                ...
                'options': ["Le respect des règles de la vie scolaire garantit la promotion d'un environnement d'apprentissage sain, le respect des autres et la construction d'une société plus juste et solidaire.", "Le respect des règles de la vie scolaire est inutile, car les individus peuvent agir comme ils le souhaitent.", "Le respect des règles de la vie scolaire est réservé aux élites politiques et économiques.", "Le respect des règles de la vie scolaire est limité aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["L'éducation joue un rôle crucial en sensibilisant les individus aux règles de la vie scolaire et en promouvant le respect de ces règles.", "L'éducation est inutile dans le respect des règles de la vie scolaire, car les individus peuvent apprendre par eux-mêmes.", "L'éducation est réservée aux élites politiques et économiques.", "L'éducation est limitée aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les enseignants jouent un rôle crucial en sensibilisant les élèves aux règles de la vie scolaire et en promouvant le respect de ces règles.", "Les médias sont inutiles dans le respect des règles de la vie scolaire, car les individus peuvent apprendre par eux-mêmes.", "Les médias sont réservés aux élites politiques et économiques.", "Les médias sont limités aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les parents ont un rôle important en sensibilisant leurs enfants aux règles de la vie scolaire et en promouvant le respect de ces règles.", "Les parents sont inutiles dans le respect des règles de la vie scolaire, car les individus peuvent apprendre par eux-mêmes.", "Les parents sont réservés aux élites politiques et économiques.", "Les parents sont limités aux écoles uniquement."],
        ...
        [
            {
                ...
                'options': ["Le respect des règles de paix et de non-violence garantit la promotion d'une société plus pacifique et respectueuse des droits de l'homme.", "Le respect des règles de paix et de non-violence est inutile, car les individus peuvent agir comme ils le souhaitent.", "Le respect des règles de paix et de non-violence est réservé aux élites politiques et économiques.", "Le respect des règles de paix et de non-violence est limité aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["L'éducation joue un rôle crucial en sensibilisant les individus aux règles de paix et de non-violence et en promouvant le respect de ces règles.", "L'éducation est inutile dans le respect des règles de paix et de non-violence, car les individus peuvent apprendre par eux-mêmes.", "L'éducation est réservée aux élites politiques et économiques.", "L'éducation est limitée aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les médias jouent un rôle crucial en sensibilisant le public aux règles de paix et de non-violence et en promouvant le respect de ces règles.", "Les médias sont inutiles dans le respect des règles de paix et de non-violence, car les individus peuvent apprendre par eux-mêmes.", "Les médias sont réservés aux élites politiques et économiques.", "Les médias sont limités aux informations locales uniquement."],
            ...
            },
            {
                ...
                'options': ["Les parents ont un rôle important en sensibilisant leurs enfants aux règles de paix et de non-violence et en promouvant le respect de ces règles.", "Les parents sont inutiles dans le respect des règles de paix et de non-violence, car les individus peuvent apprendre par eux-mêmes.", "Les parents sont réservés aux élites politiques et économiques.", "Les parents sont limités aux écoles uniquement."],
        ...
        [
            {
                ...
                'options': ["Une institution locale est une organisation ou un organisme qui gère les affaires locales et prend des décisions au niveau local.", "Une institution locale est une organisation internationale qui gère les affaires mondiales.", "Une institution locale est une organisation privée qui gère les affaires commerciales.", "Une institution locale est une organisation religieuse qui gère les affaires spirituelles."],
            ...
            },
            {
                ...
                'options': ["La mairie est responsable de la gestion des affaires locales, de la prise de décisions au niveau local et de la fourniture de services publics locaux.", "La mairie est responsable de la gestion des affaires internationales et de la prise de décisions au niveau mondial.", "La mairie est responsable de la gestion des affaires commerciales et de la prise de décisions au niveau économique.", "La mairie est responsable de la gestion des affaires spirituelles et de la prise de décisions au niveau religieux."],
            ...
            },
            {
                ...
                'options': ["Les médias jouent un rôle crucial en informant le public sur les activités des institutions locales et en encourageant la participation citoyenne.", "Les médias sont inutiles dans les institutions locales, car les individus peuvent apprendre par eux-mêmes.", "Les médias sont réservés aux élites politiques et économiques.", "Les médias sont limités aux informations nationales uniquement."],
            ...
            },
            {
                ...
                'options': ["Les parents ont un rôle important en sensibilisant leurs enfants aux institutions locales et en encourageant leur participation citoyenne.", "Les parents sont inutiles dans les institutions locales, car les individus peuvent apprendre par eux-mêmes.", "Les parents sont réservés aux élites politiques et économiques.", "Les parents sont limités aux informations nationales uniquement."],
    ...
    (
        ...
        [
            ...
            },
            {
                ...
                'options': ["Le délégué représente les élèves et fait remonter leurs préoccupations auprès de l'administration scolaire.", "Le délégué est responsable de l'enseignement des matières scolaires.", "Le délégué organise les activités sportives et culturelles.", "Le délégué est chargé de la discipline dans la classe."],
            ...
            },
            {
                ...
                'options': ["Les médias jouent un rôle crucial en informant les élèves sur les activités démocratiques à l'école et en encourageant la participation citoyenne.", "Les médias sont inutiles dans la vie démocratique à l'école, car les individus peuvent apprendre par eux-mêmes.", "Les médias sont réservés aux élites politiques et économiques.", "Les médias sont limités aux informations nationales uniquement."],
        ...
        [
            {
                ...
                'options': ["Le respect des règles de communication entre l'enseignant et l'élève garantit la promotion d'une relation de confiance, le respect mutuel et un environnement d'apprentissage positif.", "Le respect des règles de communication entre l'enseignant et l'élève est inutile, car les individus peuvent communiquer comme ils le souhaitent.", "Le respect des règles de communication entre l'enseignant et l'élève est réservé aux élites politiques et économiques.", "Le respect des règles de communication entre l'enseignant et l'élève est limité aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["L'enseignant joue un rôle crucial en établissant des règles de communication claires, en encourageant le respect mutuel et en créant un environnement d'apprentissage positif.", "L'enseignant est inutile dans la communication avec les élèves, car les individus peuvent communiquer par eux-mêmes.", "L'enseignant est réservé aux élites politiques et économiques.", "L'enseignant est limité aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les élèves jouent un rôle crucial en respectant les règles de communication, en exprimant leurs préoccupations de manière respectueuse et en contribuant à un environnement d'apprentissage positif.", "Les élèves sont inutiles dans la communication avec les enseignants, car les individus peuvent communiquer par eux-mêmes.", "Les élèves sont réservés aux élites politiques et économiques.", "Les élèves sont limités aux écoles uniquement."],
        ...
        [
            {
                ...
                'options': ["Le respect des règles de sanction à l'école garantit la promotion de la discipline, le respect des autres et un environnement d'apprentissage positif.", "Le respect des règles de sanction à l'école est inutile, car les individus peuvent agir comme ils le souhaitent.", "Le respect des règles de sanction à l'école est réservé aux élites politiques et économiques.", "Le respect des règles de sanction à l'école est limité aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["L'enseignant joue un rôle crucial en appliquant les sanctions de manière juste et équitable, en encourageant le respect mutuel et en créant un environnement d'apprentissage positif.", "L'enseignant est inutile dans l'application des sanctions à l'école, car les individus peuvent se discipliner par eux-mêmes.", "L'enseignant est réservé aux élites politiques et économiques.", "L'enseignant est limité aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les élèves jouent un rôle crucial en respectant les règles de sanction, en exprimant leurs préoccupations de manière respectueuse et en contribuant à un environnement d'apprentissage positif.", "Les élèves sont inutiles dans le respect des règles de sanction à l'école, car les individus peuvent se discipliner par eux-mêmes.", "Les élèves sont réservés aux élites politiques et économiques.", "Les élèves sont limités aux écoles uniquement."],
        ...
        [
            {
                ...
                'options': ["Le respect des règles de citoyenneté et de démocratie garantit la promotion de la participation, le respect des autres et la construction d'une société plus juste et solidaire.", "Le respect des règles de citoyenneté et de démocratie est inutile, car les individus peuvent agir comme ils le souhaitent.", "Le respect des règles de citoyenneté et de démocratie est réservé aux élites politiques et économiques.", "Le respect des règles de citoyenneté et de démocratie est limité aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Le droit de vote est un élément essentiel de la citoyenneté et de la démocratie, car il permet aux citoyens de participer aux décisions qui affectent leur communauté et leur pays.", "Le droit de vote est inutile dans la citoyenneté et la démocratie, car les individus peuvent agir comme ils le souhaitent.", "Le droit de vote est réservé aux élites politiques et économiques.", "Le droit de vote est limité aux élections nationales uniquement."],
            ...
            },
            {
                ...
                'options': ["Les citoyens jouent un rôle crucial en respectant les règles de citoyenneté et de démocratie, en participant aux décisions qui affectent leur communauté et leur pays, et en contribuant à la construction d'une société plus juste et solidaire.", "Les citoyens sont inutiles dans la citoyenneté et la démocratie, car les individus peuvent agir comme ils le souhaitent.", "Les citoyens sont réservés aux élites politiques et économiques.", "Les citoyens sont limités aux élections nationales uniquement."],
        ...
        [
            {
                ...
                'options': ["Le respect des institutions locales garantit la promotion de la participation citoyenne, le respect des autres et la construction d'une société plus juste et solidaire.", "Le respect des institutions locales est inutile, car les individus peuvent agir comme ils le souhaitent.", "Le respect des institutions locales est réservé aux élites politiques et économiques.", "Le respect des institutions locales est limité aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["La mairie joue un rôle crucial en gérant les services publics locaux, en organisant des événements communautaires et en prenant des décisions qui affectent directement la communauté locale.", "La mairie est inutile dans les institutions locales, car les individus peuvent gérer par eux-mêmes.", "La mairie est réservée aux élites politiques et économiques.", "La mairie est limitée aux informations nationales uniquement."],
            ...
            },
            {
                ...
                'type': "qcm",
                'question': "Quel est le rôle des parents dans les institutions locales ?",
                'options': ["Les parents jouent un rôle crucial en participant à la vie scolaire de leurs enfants, en soutenant les activités éducatives et en contribuant à la construction d'une communauté éducative solide.", "Les parents sont inutiles dans les institutions locales, car les individus peuvent gérer par eux-mêmes.", "Les parents sont réservés aux élites politiques et économiques.", "Les parents sont limités aux écoles uniquement."],
            ...
            },
            {
                ...
                'type': "qcm",
                'question': "Quel est le rôle des médias dans les institutions locales ?",
                'options': ["Les médias jouent un rôle crucial en informant les citoyens sur les activités locales, en encourageant la participation citoyenne et en garantissant la transparence des décisions locales.", "Les médias n'ont aucun rôle dans les institutions locales.", "Les médias sont uniquement responsables de la publicité des événements locaux.", "Les médias sont limités à la couverture des événements sportifs locaux."],
    ...
    (
        ...
        [
            ...
            },
            {
                ...
                'options': ["Les élèves jouent un rôle crucial en respectant les règles de vie démocratique, en exprimant leurs préoccupations de manière respectueuse et en contribuant à un environnement d'apprentissage positif.", "Les élèves sont inutiles dans la vie démocratique à l'école, car les individus peuvent agir par eux-mêmes.", "Les élèves sont réservés aux élites politiques et économiques.", "Les élèves sont limités aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les enseignants jouent un rôle crucial en établissant des règles de vie démocratique claires, en encourageant le respect mutuel et en créant un environnement d'apprentissage positif.", "Les enseignants sont inutiles dans la vie démocratique à l'école, car les individus peuvent agir par eux-mêmes.", "Les enseignants sont réservés aux élites politiques et économiques.", "Les enseignants sont limités aux écoles uniquement."],
            ...
            },
            {
                ...
                'type': "qcm",
                'question': "Quel est le rôle des élèves dans la vie démocratique à l'école ?",
                'options': ["Les élèves participent activement à la prise de décisions et au respect des règles de vie démocratique.", "Les élèves n'ont aucun rôle dans la vie démocratique à l'école.", "Les élèves sont uniquement responsables de leurs propres actions.", "Les élèves sont limités à suivre les instructions des enseignants."],
        ...
        [
            {
                ...
                'options': ["Le respect des règles de tolérance et de respect des différences garantit la promotion de l'inclusion, le respect des autres et la construction d'une société plus juste et solidaire.", "Le respect des règles de tolérance et de respect des différences est inutile, car les individus peuvent agir comme ils le souhaitent.", "Le respect des règles de tolérance et de respect des différences est réservé aux élites politiques et économiques.", "Le respect des règles de tolérance et de respect des différences est limité aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les élèves jouent un rôle crucial en respectant les règles de tolérance et de respect des différences, en exprimant leurs préoccupations de manière respectueuse et en contribuant à un environnement d'apprentissage positif.", "Les élèves sont inutiles dans le respect des règles de tolérance et de respect des différences, car les individus peuvent agir par eux-mêmes.", "Les élèves sont réservés aux élites politiques et économiques.", "Les élèves sont limités aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Les enseignants jouent un rôle crucial en établissant des règles de tolérance et de respect des différences claires, en encourageant le respect mutuel et en créant un environnement d'apprentissage positif.", "Les enseignants sont inutiles dans le respect des règles de tolérance et de respect des différences, car les individus peuvent agir par eux-mêmes.", "Les enseignants sont réservés aux élites politiques et économiques.", "Les enseignants sont limités aux écoles uniquement."],
        ...
        [
            {
                ...
                'options': ["Le travail scolaire à la maison est essentiel pour renforcer les compétences, approfondir les connaissances et développer l'autonomie des élèves, ce qui contribue à leur réussite scolaire et à leur développement personnel.", "Le travail scolaire à la maison est inutile, car les élèves peuvent apprendre tout ce dont ils ont besoin à l'école.", "Le travail scolaire à la maison est réservé aux élites politiques et économiques.", "Le travail scolaire à la maison est limité aux écoles uniquement."],
            ...
            },
            {
                ...
                'options': ["Renforcer les compétences", "Approfondir les connaissances", "Développer l'autonomie", "Toutes les réponses précédentes"],
