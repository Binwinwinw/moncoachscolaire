            ...
            (0001, "Les pays hispanophones", "Espagnol", "1ère", [
                {
                    ...
                    "options": ["Espagne", "Mexique", "Argentine", "Colombie"],
                    "correct_option": "Mexique",
                    "explanation": "Le Mexique est le pays hispanophone le plus peuplé avec environ 128 millions d'habitants."
                },
                {
                    "type": "vrai-faux",
                    "question": "L'espagnol est la langue officielle de 20 pays.",
                    "correct": True,
                    "explanation": "L'espagnol est la langue officielle de 20 pays, principalement en Amérique latine et en Espagne."
                },
                {
                    "type": "qcm",
                    "question": "Nommez un pays hispanophone d'Amérique du Sud.",
                    "options": ["Argentine", "Chili", "Colombie", "Pérou"],
                    "correct_option": "Argentine",
                    "explanation": "L'Argentine est un pays hispanophone d'Amérique du Sud, tout comme le Chili, la Colombie, le Pérou, etc."
                },
            ]),
]
