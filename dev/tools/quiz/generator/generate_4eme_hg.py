...
# -*- coding: utf-8 -*-
"""
Générateur quiz Histoire-Géographie 4e — SQUELETTE
"""
...
OUTPUT_DIR = os.path.join(SCRIPT_DIR, "hg_4eme_quizzes")
QUIZ_DIR = os.path.join(OUTPUT_DIR, "quiz")
ANSWERS_DIR = os.path.join(OUTPUT_DIR, "quiz_answers")

quizzes_data = [
    # À compléter : (id, titre, "Histoire-Géographie", "4e", [questions...])
]
