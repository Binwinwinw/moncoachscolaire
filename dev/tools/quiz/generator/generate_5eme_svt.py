...
def build_questions(theme: str, quiz_id: int) -> list[dict]:
    ...
    return [
        {"id": f"{quiz_id}_1", "type": "qcm", "question": f"{prefix} Sur le thème '{theme}', quelle démarche aide le plus à réussir un exercice ?", "options": ["Observer le document, les indices et le vocabulaire scientifique", "Répondre sans lire", "Ignorer le schéma", "Choisir au hasard"], "correct_option": "Observer le document, les indices et le vocabulaire scientifique", "explanation": "En SVT, les schémas, les données et le vocabulaire scientifique guident le raisonnement."},
        {"id": f"{quiz_id}_2", "type": "vrai-faux", "question": f"{prefix} Utiliser un vocabulaire scientifique précis aide à mieux traiter '{theme}'.", "correct": True, "explanation": "Le vocabulaire précis permet de mieux décrire et expliquer les phénomènes étudiés."},
        {"id": f"{quiz_id}_3", "type": "qcm", "question": f"{prefix} Quelle habitude aide à progresser sur '{theme}' ?", "options": ["Comparer plusieurs observations ou exemples", "Apprendre par cœur sans comprendre", "Éviter les documents", "Oublier ses erreurs"], "correct_option": "Comparer plusieurs observations ou exemples", "explanation": "La comparaison permet d'identifier les points communs, les différences et les liens logiques."},
        {"id": f"{quiz_id}_4", "type": "vrai-faux", "question": f"{prefix} Une réponse scientifique juste n'a pas besoin d'explication pour montrer la maîtrise de '{theme}'.", "correct": False, "explanation": "La justification permet de montrer que la notion est comprise et réutilisable."},
        {"id": f"{quiz_id}_5", "type": "qcm", "question": f"{prefix} Quel signe montre une bonne maîtrise de '{theme}' ?", "options": ["Expliquer un phénomène avec des observations précises", "Réciter un mot isolé", "Répondre vite seulement", "Ignorer les causes"], "correct_option": "Expliquer un phénomène avec des observations précises", "explanation": "Une explication claire appuyée sur les observations montre une compréhension solide."},
        {"id": f"{quiz_id}_6", "type": "vrai-faux", "question": f"{prefix} Relire un schéma ou un tableau peut aider à mieux comprendre '{theme}'.", "correct": True, "explanation": "Les schémas et tableaux contiennent souvent les indices utiles à l'analyse."},
        {"id": f"{quiz_id}_7", "type": "qcm", "question": f"{prefix} Si tu bloques sur une question liée à '{theme}', quel réflexe est le plus pertinent ?", "options": ["Revenir aux observations et reformuler le problème", "Abandonner tout de suite", "Ignorer le document", "Changer de sujet"], "correct_option": "Revenir aux observations et reformuler le problème", "explanation": "Le retour aux faits observables aide à remettre le raisonnement en marche."},
        {"id": f"{quiz_id}_8", "type": "vrai-faux", "question": f"{prefix} Corriger ses erreurs après un quiz aide à progresser sur '{theme}'.", "correct": True, "explanation": "Le retour sur erreur renforce la compréhension et la mémorisation en sciences."},
    ]
