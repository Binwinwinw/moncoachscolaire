...
# -*- coding: utf-8 -*-
"""
Générateur quiz Mathématiques 5e — SQUELETTE
"""
...
OUTPUT_DIR = os.path.join(SCRIPT_DIR, "mathematiques_5eme_quizzes")
QUIZ_DIR = os.path.join(OUTPUT_DIR, "quiz")
ANSWERS_DIR = os.path.join(OUTPUT_DIR, "quiz_answers")

quizzes_data = [
    # À compléter : (id, titre, "Mathématiques", "5e", [questions...])
]
