...
(867, "Codage binaire des entiers", "NSI", "1ère", [
    ...
    {"id":"867_3","type":"texte","question":"Convertissez le nombre décimal 42 en binaire.",
    ...
    {"id":"867_6","type":"texte","question":"Comment représente-t-on -5 en complément à deux sur 8 bits ?",
...
(868, "Codage des caractères", "NSI", "1ère", [
    ...
    {"id":"868_3","type":"texte","question":"Quelle est la différence entre Unicode et UTF-8 ?",
    ...
    {"id":"868_6","type":"texte","question":"Pourquoi UTF-8 est-il devenu le standard dominant sur le web ?",
...
(869, "Codage des images", "NSI", "1ère", [
    ...
    {"id":"869_3","type":"texte","question":"Calculez la taille non compressée d'une image RGB de 800×600 pixels (en octets et Mo).",
    ...
    {"id":"869_6","type":"texte","question":"Expliquez la différence entre compression avec perte et sans perte.",
...
(870, "Codage des nombres flottants", "NSI", "1ère", [
    ...
    {"id":"870_3","type":"texte","question":"Expliquez pourquoi 0.1 ne peut pas être représenté exactement en binaire.",
    ...
    {"id":"870_6","type":"texte","question":"Qu'est-ce que le dépassement de capacité (overflow) en virgule flottante ?",
...
(871, "Algèbre de Boole et portes logiques", "NSI", "1ère", [
    ...
    {"id":"871_3","type":"texte","question":"Construisez la table de vérité du XOR (OU exclusif) pour deux entrées A et B.",
    ...
    {"id":"871_6","type":"texte","question":"Qu'est-ce qu'un circuit combinatoire ? Donnez un exemple.",
...
(872, "Hexadécimal et conversions", "NSI", "1ère", [
    ...
    {"id":"872_3","type":"texte","question":"Convertissez le nombre hexadécimal 2A en décimal et en binaire.",
    ...
    {"id":"872_6","type":"texte","question":"Pourquoi l'hexadécimal est-il souvent préféré au binaire en informatique ?",
...
(873, "Listes et tableaux en Python", "NSI", "1ère", [
    ...
    {"id":"873_3","type":"texte","question":"Qu'est-ce que le slicing (découpage) de liste en Python ? Donnez un exemple.",
    ...
    {"id":"873_6","type":"texte","question":"Expliquez la différence entre une liste et un tableau (array) numpy.",
...
(874, "Dictionnaires en Python", "NSI", "1ère", [
    ...
    {"id":"874_3","type":"texte","question":"Comment itérer sur les clés, les valeurs et les paires clé-valeur d'un dictionnaire ?",
    ...
    {"id":"874_6","type":"texte","question":"Qu'est-ce qu'un dictionnaire par compréhension (dict comprehension) ? Donnez un exemple.",
...
(875, "Tuples et ensembles", "NSI", "1ère", [
    ...
    {"id":"875_3","type":"texte","question":"Expliquez le dépaquetage (unpacking) de tuples en Python avec un exemple.",
    ...
    {"id":"875_6","type":"texte","question":"Quand utiliser un set plutôt qu'une liste en Python ?",
...
(876, "Fichiers CSV et traitement de données", "NSI", "1ère", [
    ...
    {"id":"876_3","type":"texte","question":"Écrivez le code Python pour lire un fichier 'data.csv' et afficher chaque ligne en tant que dictionnaire.",
    ...
    {"id":"876_6","type":"texte","question":"Comment filtrer les lignes d'un DataFrame pandas où la colonne 'age' est supérieure à 18 ?",
...
(877, "Algorithmes de recherche dans des données", "NSI", "1ère", [
    ...
    {"id":"877_3","type":"texte","question":"Expliquez le principe de la recherche dichotomique et donnez sa complexité.",
    ...
    {"id":"877_6","type":"texte","question":"Implémentez la recherche dichotomique en Python.",
...
(878, "Tri de données", "NSI", "1ère", [
    ...
    {"id":"878_3","type":"texte","question":"Expliquez le principe du tri par insertion.",
    ...
    {"id":"878_6","type":"texte","question":"Comment trier une liste de dictionnaires par la valeur d'une clé en Python ?",
...
(879, "HTML — Structure d'une page web", "NSI", "1ère", [
    ...
    {"id":"879_3","type":"texte","question":"Quelle est la structure minimale d'une page HTML5 valide ?",
    ...
    {"id":"879_6","type":"texte","question":"Expliquez la différence entre balises <div> et <span>.",
...
(880, "CSS — Mise en forme", "NSI", "1ère", [
    ...
    {"id":"880_3","type":"texte","question":"Expliquez le modèle de boîte (box model) en CSS.",
    ...
    {"id":"880_6","type":"texte","question":"Qu'est-ce que le responsive design et comment le CSS y contribue-t-il ?",
...
(881, "Formulaires HTML et interactivité", "NSI", "1ère", [
    ...
    {"id":"881_3","type":"texte","question":"Quels sont les principaux types de champs <input> en HTML5 ?",
    ...
    {"id":"881_6","type":"texte","question":"Expliquez la différence entre GET et POST dans un formulaire.",
...
(882, "Introduction à JavaScript", "NSI", "1ère", [
    ...
    {"id":"882_3","type":"texte","question":"Qu'est-ce que le DOM (Document Object Model) ?",
    ...
    {"id":"882_6","type":"texte","question":"Expliquez ce qu'est une fonction fléchée (arrow function) en JavaScript.",
...
(883, "Protocole HTTP", "NSI", "1ère", [
    ...
    {"id":"883_3","type":"texte","question":"Quels sont les principaux codes de statut HTTP et leur signification ?",
    ...
    {"id":"883_6","type":"texte","question":"Expliquez le rôle des cookies HTTP.",
...
(884, "API et services web", "NSI", "1ère", [
    ...
    {"id":"884_3","type":"texte","question":"Comment interroger une API web en Python avec le module requests ?",
    ...
    {"id":"884_6","type":"texte","question":"Qu'est-ce que le web scraping et quelles sont ses limites éthiques et légales ?",
...
(885, "Algorithmes de recherche", "NSI", "1ère", [
    ...
    {"id":"885_3","type":"texte","question":"Décrivez en pseudo-code la recherche séquentielle dans un tableau.",
    ...
    {"id":"885_6","type":"texte","question":"Qu'est-ce que l'invariant de boucle et à quoi sert-il ?",
...
(886, "Algorithmes de tri", "NSI", "1ère", [
    ...
    {"id":"886_3","type":"texte","question":"Implémentez le tri par insertion en Python.",
    ...
    {"id":"886_6","type":"texte","question":"Expliquez le principe du tri rapide (quicksort).",
...
(887, "Complexité algorithmique", "NSI", "1ère", [
    ...
    {"id":"887_3","type":"texte","question":"Classez les complexités suivantes de la plus rapide à la plus lente : O(n²), O(1), O(n log n), O(log n), O(n).",
    ...
    {"id":"887_6","type":"texte","question":"Qu'est-ce que la notation grand O (Big O) capture-t-elle et qu'ignore-t-elle ?",
...
(888, "Récursivité", "NSI", "1ère", [
    ...
    {"id":"888_3","type":"texte","question":"Écrivez en Python une fonction récursive calculant la factorielle de n.",
    ...
    {"id":"888_6","type":"texte","question":"Expliquez la suite de Fibonacci récursive et son problème de complexité.",
...
(889, "Algorithmes gloutons", "NSI", "1ère", [
    ...
    {"id":"889_3","type":"texte","question":"Appliquez l'algorithme glouton au problème du rendu de monnaie : rendre 41 centimes avec des pièces de 25, 10, 5 et 1 centime.",
    ...
    {"id":"889_6","type":"texte","question":"Expliquez l'algorithme glouton de coloration de graphe.",
...
(890, "Arbres et parcours", "NSI", "1ère", [
    ...
    {"id":"890_3","type":"texte","question":"Décrivez les trois ordres de parcours d'un arbre binaire.",
    ...
    {"id":"890_6","type":"texte","question":"Implémentez en Python le parcours infixe d'un arbre binaire.",
...
(891, "Variables, types et expressions", "NSI", "1ère", [
    ...
    {"id":"891_3","type":"texte","question":"Quelle est la différence entre les opérateurs // et / en Python ?",
    ...
    {"id":"891_6","type":"texte","question":"Expliquez la différence entre = et == en Python.",
...
(892, "Structures conditionnelles", "NSI", "1ère", [
    ...
    {"id":"892_3","type":"texte","question":"Écrivez une fonction Python qui retourne 'positif', 'négatif' ou 'nul' selon le signe d'un nombre.",
    ...
    {"id":"892_6","type":"texte","question":"Expliquez le court-circuit (short-circuit evaluation) des opérateurs and et or en Python.",
...
(893, "Boucles for et while", "NSI", "1ère", [
    ...
    {"id":"893_3","type":"texte","question":"Quelle est la différence entre break et continue dans une boucle Python ?",
    ...
    {"id":"893_6","type":"texte","question":"Écrivez une boucle Python pour calculer la somme des nombres pairs de 1 à 100.",
...
(894, "Fonctions et portée des variables", "NSI", "1ère", [
    ...
    {"id":"894_3","type":"texte","question":"Expliquez la portée des variables (LEGB rule) en Python.",
    ...
    {"id":"894_6","type":"texte","question":"Qu'est-ce qu'une fonction lambda en Python ? Donnez un exemple.",
...
(895, "Modules et bibliothèques Python", "NSI", "1ère", [
    ...
    {"id":"895_3","type":"texte","question":"À quoi sert le module os en Python ? Citez trois fonctions utiles.",
    ...
    {"id":"895_6","type":"texte","question":"Qu'est-ce qu'un environnement virtuel Python (venv) et pourquoi l'utiliser ?",
...
(896, "Gestion des erreurs et exceptions", "NSI", "1ère", [
    ...
    {"id":"896_3","type":"texte","question":"Quelles sont les exceptions Python les plus courantes ?",
    ...
    {"id":"896_6","type":"texte","question":"Expliquez l'utilisation de 'with open()' pour lire un fichier en Python.",
...
(897, "Architecture de Von Neumann", "NSI", "1ère", [
    ...
    {"id":"897_3","type":"texte","question":"Expliquez le rôle de l'unité arithmétique et logique (UAL) dans le CPU.",
    ...
    {"id":"897_6","type":"texte","question":"Qu'est-ce que la fréquence d'horloge d'un processeur et quelle est sa limite ?",
...
(898, "Systèmes de numération et codage binaire", "NSI", "1ère", [
    ...
    {"id":"898_3","type":"texte","question":"Comment convertir un nombre décimal en binaire ?",
    ...
    {"id":"898_6","type":"texte","question":"Qu'est-ce que le code Unicode et pourquoi a-t-il été créé ?",
