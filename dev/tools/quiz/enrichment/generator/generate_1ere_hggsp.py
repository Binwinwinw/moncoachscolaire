...
(915, "Histoire de la conquête spatiale", "HGGSP", "1ère", [
    ...
    {"id":"915_3","type":"vrai-faux","question":"Pourquoi la conquête spatiale des années 1957-1969 est-elle indissociable du contexte de Guerre froide ?",
    ...
    {"id":"915_6","type":"vrai-faux","question":"Quelles sont les principales agences spatiales mondiales et leurs pays d'appartenance ?",
...
(916, "Les nouveaux acteurs de la conquête spatiale", "HGGSP", "1ère", [
    ...
    {"id":"916_3","type":"vrai-faux","question":"Qu'est-ce que le New Space et en quoi représente-t-il un changement dans le secteur spatial ?",
    ...
    {"id":"916_6","type":"vrai-faux","question":"Quels sont les enjeux économiques liés aux ressources de la Lune ?",
...
(917, "L'espace, enjeu géopolitique", "HGGSP", "1ère", [
    ...
    {"id":"917_3","type":"vrai-faux","question":"En quoi le contrôle des satellites est-il un enjeu stratégique militaire ?",
    ...
    {"id":"917_6","type":"vrai-faux","question":"Quels sont les risques liés à la militarisation croissante de l'espace ?",
...
(918, "Les usages civils et économiques de l'espace", "HGGSP", "1ère", [
    ...
    {"id":"918_3","type":"vrai-faux","question":"Comment les satellites météorologiques contribuent-ils à la prévision des catastrophes naturelles ?",
    ...
    {"id":"918_6","type":"vrai-faux","question":"Quels sont les enjeux de l'exploitation des ressources minières dans l'espace (astéroïdes, Lune) ?",
...
(919, "La militarisation et l'arsenalisation de l'espace", "HGGSP", "1ère", [
    ...
    {"id":"919_3","type":"vrai-faux","question":"Distinguez militarisation et arsenalisation de l'espace.",
    ...
    {"id":"919_6","type":"vrai-faux","question":"Quelles sont les formes de guerre asymétrique applicables à l'espace ?",
...
(920, "L'espace, bien commun de l'humanité ?", "HGGSP", "1ère", [
    ...
    {"id":"920_3","type":"vrai-faux","question":"Pourquoi les pays en développement défendent-ils le principe de 'patrimoine commun de l'humanité' pour l'espace ?",
    ...
    {"id":"920_6","type":"vrai-faux","question":"Quels sont les défis de la gouvernance internationale de l'espace au XXIe siècle ?",
...
(921, "Les fonds marins : exploration et ressources", "HGGSP", "1ère", [
    ...
    {"id":"921_3","type":"vrai-faux","question":"Qu'est-ce qu'un champ hydrothermal sous-marin et quelles ressources contient-il ?",
    ...
    {"id":"921_6","type":"vrai-faux","question":"Pourquoi l'exploitation des fonds marins soulève-t-elle des questions environnementales ?",
...
(922, "La gouvernance des océans", "HGGSP", "1ère", [
    ...
    {"id":"922_3","type":"vrai-faux","question":"Quels sont les principaux défis de la gouvernance des espaces maritimes aujourd'hui ?",
    ...
    {"id":"922_6","type":"vrai-faux","question":"Présentez le Traité sur la haute mer (BBNJ) adopté en 2023 et ses enjeux.",
...
(923, "Le cyberespace : définition et enjeux", "HGGSP", "1ère", [
    ...
    {"id":"923_3","type":"vrai-faux","question":"Quelles sont les quatre couches du cyberespace ?",
    ...
    {"id":"923_6","type":"vrai-faux","question":"Qu'est-ce que la fracture numérique et quelles en sont les dimensions ?",
...
(924, "La cybersécurité et les cyberattaques", "HGGSP", "1ère", [
    ...
    {"id":"924_3","type":"vrai-faux","question":"Qu'est-ce qu'une cyberattaque d'État et quels exemples peut-on citer ?",
    ...
    {"id":"924_6","type":"vrai-faux","question":"Quels sont les défis de l'attribution des cyberattaques ?",
...
(925, "La gouvernance d'Internet", "HGGSP", "1ère", [
    ...
    {"id":"925_3","type":"vrai-faux","question":"Qu'est-ce que la neutralité du Net et pourquoi est-elle débattue ?",
    ...
    {"id":"925_6","type":"vrai-faux","question":"Expliquez les enjeux de la souveraineté numérique pour les États européens.",
...
(926, "Numérique et nouvelles frontières", "HGGSP", "1ère", [
    ...
    {"id":"926_3","type":"vrai-faux","question":"En quoi le contrôle des câbles sous-marins est-il un enjeu géopolitique majeur ?",
    ...
    {"id":"926_6","type":"vrai-faux","question":"Qu'est-ce que la guerre informationnelle (information warfare) et comment s'illustre-t-elle aujourd'hui ?",
...
(927, "Les formes de conflits armés au XXe siècle", "HGGSP", "1ère", [
    ...
    {"id":"927_3","type":"vrai-faux","question":"Qu'est-ce que la dissuasion nucléaire et comment a-t-elle influencé les conflits pendant la Guerre froide ?",
    ...
    {"id":"927_6","type":"vrai-faux","question":"Distinguez conflit interétatique et conflit intra-étatique en donnant des exemples.",
...
(928, "Guerres asymétriques, terrorisme et nouvelles formes de conflits", "HGGSP", "1ère", [
    ...
    {"id":"928_3","type":"vrai-faux","question":"Quels ont été les impacts géopolitiques des attentats du 11 septembre 2001 ?",
    ...
    {"id":"928_6","type":"vrai-faux","question":"Qu'est-ce qu'une guerre hybride ? Donnez l'exemple de la Russie en Ukraine (2014-2015).",
...
(929, "L'ONU et le maintien de la paix", "HGGSP", "1ère", [
    ...
    {"id":"929_3","type":"vrai-faux","question":"Quelles sont les limites du droit de veto dans le fonctionnement du Conseil de sécurité ?",
    ...
    {"id":"929_6","type":"vrai-faux","question":"Quelle est la différence entre une opération de maintien de la paix et une opération d'imposition de la paix ?",
...
(930, "La diplomatie et la résolution des conflits", "HGGSP", "1ère", [
    ...
    {"id":"930_3","type":"vrai-faux","question":"Quels sont les différents modes de règlement pacifique des différends internationaux ?",
    ...
    {"id":"930_6","type":"vrai-faux","question":"Qu'est-ce que la diplomatie multilatérale et quelles en sont les enceintes principales ?",
...
(931, "Le droit international humanitaire", "HGGSP", "1ère", [
    ...
    {"id":"931_3","type":"vrai-faux","question":"Quels sont les principes fondamentaux du droit international humanitaire ?",
    ...
    {"id":"931_6","type":"vrai-faux","question":"Comment le DIH encadre-t-il l'utilisation des armes autonomes (drones, robots armés) ?",
...
(932, "Conflits contemporains et construction de la paix", "HGGSP", "1ère", [
    ...
    {"id":"932_3","type":"vrai-faux","question":"Qu'est-ce que la consolidation de la paix (peacebuilding) et quels en sont les instruments ?",
    ...
    {"id":"932_6","type":"vrai-faux","question":"Quelles sont les 'nouvelles guerres' selon la politologue Mary Kaldor ?",
...
(933, "Mémoire collective et histoire", "HGGSP", "1ère", [
    ...
    {"id":"933_3","type":"vrai-faux","question":"Expliquez la distinction entre histoire et mémoire selon Paul Ricœur.",
    ...
    {"id":"933_6","type":"vrai-faux","question":"Qu'est-ce que le 'devoir de mémoire' et quelles en sont les limites ?",
...
(934, "La mémoire de la Seconde Guerre mondiale", "HGGSP", "1ère", [
    ...
    {"id":"934_3","type":"vrai-faux","question":"Comment la mémoire de la Résistance et de Vichy a-t-elle évolué en France depuis 1944 ?",
    ...
    {"id":"934_6","type":"vrai-faux","question":"Qu'est-ce que le négationnisme et pourquoi est-il combattu par les historiens et les États ?",
...
(935, "Mémoires des décolonisations et de l'esclavage", "HGGSP", "1ère", [
    ...
    {"id":"935_3","type":"vrai-faux","question":"Qu'est-ce que le mouvement de décolonisation et comment s'est-il manifesté en Afrique subsaharienne ?",
    ...
    {"id":"935_6","type":"vrai-faux","question":"Pourquoi la question des réparations liées à l'esclavage est-elle débattue aujourd'hui ?",
...
(936, "Le rôle de l'État dans la construction des mémoires", "HGGSP", "1ère", [
    ...
    {"id":"936_3","type":"vrai-faux","question":"Comment les politiques mémorielles peuvent-elles être instrumentalisées politiquement ?",
    ...
    {"id":"936_6","type":"vrai-faux","question":"Qu'est-ce qu'un 'roman national' et quelles sont ses limites ?",
...
(937, "Usages politiques du passé", "HGGSP", "1ère", [
    ...
    {"id":"937_3","type":"vrai-faux","question":"En quoi le conflit entre Serbes et Bosniaques dans les années 1990 a-t-il mobilisé des mémoires historiques ?",
    ...
    {"id":"937_6","type":"vrai-faux","question":"Comment les monuments commémoratifs participent-ils à la construction d'une mémoire nationale ?",
...
(938, "Mémoire et identité nationale", "HGGSP", "1ère", [
    ...
    {"id":"938_3","type":"vrai-faux","question":"Comment la commémoration du 11 novembre a-t-elle évolué en France ?",
    ...
    {"id":"938_6","type":"vrai-faux","question":"Pourquoi la question de l'histoire coloniale dans les manuels français fait-elle débat ?",
...
(939, "Définitions et catégories du patrimoine", "HGGSP", "1ère", [
    ...
    {"id":"939_3","type":"vrai-faux","question":"Qu'est-ce que le patrimoine culturel matériel et quels en sont les enjeux de conservation ?",
    ...
    {"id":"939_6","type":"vrai-faux","question":"Qu'est-ce que la patrimonialisation et quels sont ses effets sur les communautés locales ?",
...
(940, "Menaces et défis pour le patrimoine mondial", "HGGSP", "1ère", [
    ...
    {"id":"940_2","type":"vrai-faux","question":"Le changement climatique n'affecte pas les sites du patrimoine mondial situés en zone tempérée.",
        ...
        {"id":"940_3","type":"vrai-faux","question":"Comment les conflits armés menacent-ils le patrimoine mondial ?",
        ...
        {"id":"940_6","type":"vrai-faux","question":"Quelles sont les stratégies de conservation pour protéger le patrimoine mondial ?",
