    ...
    (
        ...
        [
            ...
            },
            {
                'id': "146_5",
                'type': "qcm",
                'question': "Quel type de texte présente des faits et des informations de manière organisée pour informer le lecteur ?",
                'options': ["Texte narratif", "Texte descriptif", "Texte argumentatif", "Texte explicatif"],
                'correct_option': "Texte explicatif",
                'explanation': "Un texte explicatif présente des faits et des informations de manière organisée pour informer le lecteur."
            },
            {
                'id': "146_6",
                'type': "vrai-faux",
    ...
    (
        ...
        [
            ...
            },
            {
                'id': "147_8",
                'type': "vrai-faux",
                'question': "La poésie est un genre littéraire qui utilise des vers et des strophes pour exprimer des émotions.",
                'correct': True,
                'explanation': "C'est vrai. La poésie utilise des vers et des strophes pour exprimer des émotions et des idées de manière artistique."
            },
        ]
    ),
    (
    ...
    (
        ...
        [
            ...
            },
            {
                'id': "152_7",
                'type': "qcm",
                'question': "Quel temps verbal est utilisé pour annoncer un événement futur certain ?",
                'options': ["Présent", "Passé composé", "Imparfait", "Futur simple"],
                'correct_option': "Futur simple",
                'explanation': "Le futur simple est utilisé pour annoncer un événement futur certain."
            },
            {
                'id': "152_8",
                'type': "vrai-faux",
    ...
    (
        ...
        [
            ...
            },
            {
                ...
                'options': ["visité", "visitée", "visités", "visitées"],
    ...
    (
        ...
        [
            ...
            },
            {
                'id': "172_7",
                'type': "qcm",
                'question': "Quel verbe est utilisé pour exprimer une capacité ou une possibilité ?",
                'options': ["Pouvoir", "Devoir", "Vouloir", "Savoir"],
                'correct_option': "Pouvoir",
                'explanation': "Le verbe 'pouvoir' est utilisé pour exprimer une capacité ou une possibilité, en indiquant que quelque chose est réalisable ou accessible dans une situation donnée."
            },
            {
                'id': "172_8",
                'type': "vrai-faux",
